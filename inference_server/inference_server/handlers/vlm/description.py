...
_KEYPOINTS_IMAGE_ONLY = ModelHandlerDescription(
    input_parser=parse_vlm_input,
    handler=handle_vlm,
    output_serializer=serialize_vlm_detections,
    interface_provider=get_vlm_keypoints_image_only_interface,
)
...
_register("vlm", "segment_phrase", _DETECTIONS_PROMPT)
_register("vlm", "ground_phrase", _DETECTIONS_PROMPT)
...
_register("vlm", "point", _KEYPOINTS_IMAGE_ONLY)
