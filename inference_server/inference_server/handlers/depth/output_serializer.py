...
def _serialize_one(prediction: Any, style: str) -> Any:
    ...
    return serialize_depth_compact(prediction, proxy)


def serialize_depth(prediction: Any, common: CommonRequestParams) -> Response:
    ...
    envelope = {
        ...
        "model_info": {"model_id": common.model_id, "task": "depth-estimation"},
        "usage": {},
        "predictions": typed,
    }
    return Response(
