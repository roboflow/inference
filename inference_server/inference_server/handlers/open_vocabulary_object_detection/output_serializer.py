...
def _serialize_one(prediction: Any, style: str, class_names: Optional[list]) -> Any:
...
def serialize_open_vocabulary_object_detection(
    ...
    class_names = common.extra.get("classes")
    if isinstance(class_names, str):
        class_names = [class_names]
    typed = [_serialize_one(p, style, class_names) for p in items]
    envelope = {
