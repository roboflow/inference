...
def test_prepare_container_environment_when_env_file_defined(read_env_file_mock: MagicMock) -> None:
    # given
    read_env_file_mock.return_value = {"API_KEY": "my_api_key", "DEVICE_ID": "other", "SOME": "VALUE"}
