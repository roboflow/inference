...
def test_get_roboflow_workspace_models_returns_projects(requests_mock: Mocker) -> None:
    ...
    result = get_roboflow_workspace_models(api_key="test_key_ws_1")
...
def test_get_roboflow_workspace_models_returns_empty_when_no_projects(
    requests_mock: Mocker,
) -> None:
    from inference.core.roboflow_api import get_roboflow_workspace_models
    ...
    result = get_roboflow_workspace_models(api_key="test_key_ws_2")
    assert result == ()


def test_get_roboflow_workspace_models_defaults_type_when_missing(
    requests_mock: Mocker,
) -> None:
    from inference.core.roboflow_api import get_roboflow_workspace_models
    ...
    result = get_roboflow_workspace_models(api_key="test_key_ws_3")
    assert result[0]["type"] == "object-detection"


def test_get_roboflow_workspace_models_raises_on_unauthorized(
    requests_mock: Mocker,
) -> None:
    from inference.core.roboflow_api import get_roboflow_workspace_models
    ...
    with pytest.raises(RoboflowAPINotAuthorizedError):
        get_roboflow_workspace_models(api_key="bad_key_ws")
