...
2. Core model routes — discovered via GENERIC_MODELS prefix matching.
3. URL construction and error handling.
"""
...
class TestListModelsPublicAliases:
    ...
    def test_get_model_type_called_once_per_dataset(self, client: TestClient):
        ...
        mocks = _mock_roboflow_api()
        with mocks["model_type"] as mock_mt:
