...
def test_sample_based_on_classes_for_detection_predictions_when_classes_detected() -> (
    None
):
    # when
...
def test_sample_based_on_classes_for_detection_predictions_when_classes_not_detected() -> (
    None
):
    # when
    result = sample_based_on_classes(
...
def test_initialize_classes_based_sampling_when_minimum_objects_specified(
...
@mock.patch.object(contains_classes, "partial")
def test_initialize_classes_based_sampling_when_minimum_objects_not_specified(
    partial_mock: MagicMock,
) -> None:
    # given
    strategy_config = {
