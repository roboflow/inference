...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([[(10, 10), (20, 20), (10, 20)]], (100, 100), (100, 10), {}, np.array([[(1, 10), (2, 20), (1, 20)]]), DoesNotRaise()),  # square -> rectangular (shrink horizontally)
        ([[(10, 10), (20, 20), (10, 20)]], (20, 200), (200, 200), {}, np.array([[(10, 100), (20, 200), (10, 200)]]), DoesNotRaise()),  # rectangular -> square (inflate vertically)
