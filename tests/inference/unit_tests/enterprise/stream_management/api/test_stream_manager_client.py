...
from inference.enterprise.stream_management.api import stream_manager_client
...
from inference.enterprise.stream_management.manager.entities import CommandType
