...
def test_yolov10_detection_single_image_inference(
    ...
    yolov10_det_reference_prediction: ObjectDetectionInferenceResponse,
) -> None:
    # given
    ...
    assert_localized_predictions_match(result_prediction=result[0], reference_prediction=yolov10_det_reference_prediction)
...
def test_yolov10_detection_batch_inference_when_batch_size_smaller_than_max_batch_size(
    ...
    for prediction in result:
        assert_localized_predictions_match(result_prediction=prediction, reference_prediction=yolov10_det_reference_prediction)
