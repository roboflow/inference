...
def test_yolov10_detection_single_image_inference(
    ...
    assert_localized_predictions_match(prediction_1=result[0], prediction_2=yolov10_det_reference_prediction)
...
def test_yolov10_detection_batch_inference_when_batch_size_smaller_than_max_batch_size(
    ...
    for prediction in result:
        assert_localized_predictions_match(prediction_1=prediction, prediction_2=yolov10_det_reference_prediction)
