...
@add_to_workflows_gallery(
    ...
    use_case_title="Dimension Rollup with All Detection Types",
    use_case_description="""
Comprehensive workflow testing dimension_rollup with object detection,
...
@add_to_workflows_gallery(
    ...
    use_case_description="""
Test dimension_rollup with object detection predictions. Demonstrates how to
