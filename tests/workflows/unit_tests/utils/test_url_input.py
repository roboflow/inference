"""Security cases for `inference.core.workflows.utils.url_input`.
...
from inference.core.workflows.utils import url_input
from inference.core.workflows.utils.url_input import (
