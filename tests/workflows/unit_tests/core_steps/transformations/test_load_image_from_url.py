...
@patch(
    "inference.core.workflows.core_steps.transformations.load_image_from_url.v1.load_image_from_url"
)
...
def test_load_image_from_url_block_run_caching_behavior(
...
def test_load_image_from_url_block_validates_invalid_url_format_at_runtime(
    mock_load_image_from_url,
) -> None:
    # given
...
def test_load_image_from_url_block_validates_non_image_extension_at_runtime(
    mock_load_image_from_url,
) -> None:
    # given
