...
def test_qwen3_6_openrouter_step_validation_when_image_is_invalid(
    value: Any,
) -> None:
    # given
    specification = {
...
def test_qwen3_6_openrouter_step_validation_when_prompt_is_given_directly() -> None:
    # given
    specification = {
        "type": "roboflow_core/qwen3_6_openrouter@v1",
        "name": "step_1",
...
def test_qwen3_6_openrouter_step_validation_when_prompt_is_invalid(
    value: Any,
) -> None:
    # given
    specification = {
...
def test_qwen3_6_openrouter_step_validation_when_model_type_valid(
    value: str,
) -> None:
    # given
    specification = {
...
def test_qwen3_6_openrouter_step_validation_when_model_type_invalid(
    value: Any,
) -> None:
    # given
    specification = {
...
def test_qwen3_6_openrouter_step_validation_when_temperature_is_invalid(
    value: float,
) -> None:
    # given
    specification = {
...
def test_qwen3_6_openrouter_when_prompt_not_delivered_when_required(value: str) -> None:
    # given
    specification = {
        "type": "roboflow_core/qwen3_6_openrouter@v1",
        "task_type": value,
...
def test_qwen3_6_openrouter_when_classes_not_delivered_when_required(
    value: str,
) -> None:
    # given
    specification = {
...
def test_qwen3_6_openrouter_when_output_structure_not_delivered_when_required() -> None:
    # given
    specification = {
        "type": "roboflow_core/qwen3_6_openrouter@v1",
...
def test_execute_qwen_request_when_request_succeeds() -> None:
    ...
    result = execute_qwen_request(
        ...
        qwen_model_version="qwen/qwen3.6-35b-a3b",
        max_tokens=300,
        temperature=0.5,
    )
    ...
    assert call_kwargs["model"] == "qwen/qwen3.6-35b-a3b"
