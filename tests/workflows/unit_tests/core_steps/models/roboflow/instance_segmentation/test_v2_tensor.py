...
def test_run_locally_outputs_model_id_and_enforces_rle() -> None:
    # given
    ...
    block = RoboflowInstanceSegmentationModelBlockV2(
...
def test_run_remotely_requests_rle_response_format() -> None:
    ...
    # when
    with patch(
        "inference.core.workflows.core_steps.models.roboflow.instance_segmentation.v2_tensor.InferenceHTTPClient",
        return_value=http_client,
    ), patch(
        "inference.core.workflows.core_steps.models.roboflow.instance_segmentation.v2_tensor.InferenceConfiguration"
    ) as Cfg:
