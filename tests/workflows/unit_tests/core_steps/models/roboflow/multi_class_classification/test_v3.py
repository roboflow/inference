...
def test_classification_model_validation_when_custom_mode_missing_custom_confidence() -> (
    None
):
    # given
    data = {
...
def test_classification_model_validation_rejects_best_confidence_mode() -> None:
    # Single-label classification opts out of per-class refinement, so "best"
    # is not offered.
    data = {
        "type": "roboflow_core/roboflow_classification_model@v3",
        "name": "some",
...
def test_classification_model_when_parameters_have_invalid_type(
    parameter: str,
    value: Any,
) -> None:
    # given
