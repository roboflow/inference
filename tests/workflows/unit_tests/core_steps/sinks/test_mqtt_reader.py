...
from inference.enterprise.workflows.enterprise_blocks.sinks.mqtt_reader import v1
from inference.enterprise.workflows.enterprise_blocks.sinks.mqtt_reader.v1 import (
    LATEST_BUFFER_SIZE,
...
CLIENT_CLASS_PATH = (
    "inference.enterprise.workflows.enterprise_blocks.sinks.mqtt_reader.v1.mqtt.Client"
)
...
class TestManifest:
    ...
    def test_restrictions_hard_for_hosted_and_soft_for_self_hosted_images(self):
