...
def test_build_event_payload_includes_workflow_url_as_workflow_id() -> None:
    payload = _build_event_payload(
        event_type="custom",
        solution="test",
        images=[],
    ...
    assert payload["workflowId"] == "https://app.roboflow.com/workflows/ws/wf-abc"


def test_build_event_payload_omits_workflow_id_when_workflow_url_is_none() -> None:
    payload = _build_event_payload(
        event_type="custom",
        solution="test",
        images=[],
