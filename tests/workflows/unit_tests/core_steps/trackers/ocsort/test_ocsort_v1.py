...
from inference.core.workflows.core_steps.trackers.ocsort.v1 import OCSORTTrackerBlockV1
...
def test_ocsort_tracker() -> None:
    # given
    # OC-SORT filters detections below high_conf_det_threshold (default 0.6), so use 0.9.
...
def test_ocsort_tracker_not_video_file() -> None:
    # given
    frame1_detections = sv.Detections(
        xyxy=np.array(
            [[10, 10, 20, 20], [21, 10, 31, 20], [31, 10, 41, 20], [100, 100, 110, 110]]
...
def test_ocsort_tracker_missing_fps() -> None:
