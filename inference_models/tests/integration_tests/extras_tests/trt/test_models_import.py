...
def test_import_of_trt_utils() -> None:
    import inference_models.models.common.trt
...
def test_import_yolov5_instance_segmentation_trt() -> None:
    from inference_models.models.yolov5.yolov5_instance_segmentation_trt import (
...
def test_import_yolov5_object_detection_trt() -> None:
    from inference_models.models.yolov5.yolov5_object_detection_trt import (
...
def test_import_yolov7_instance_segmentation_trt() -> None:
    from inference_models.models.yolov7.yolov7_instance_segmentation_trt import (
...
def test_import_yolov9_object_detection_trt() -> None:
    from inference_models.models.yolov9.yolov9_trt import YOLOv9ForObjectDetectionTRT
...
def test_import_yolov11_object_detection_trt() -> None:
    from inference_models.models.yolov11.yolov11_trt import YOLOv11ForObjectDetectionTRT


@pytest.mark.trt_extras
def test_import_yolov11_instance_segmentation_trt() -> None:
    from inference_models.models.yolov11.yolov11_trt import (
