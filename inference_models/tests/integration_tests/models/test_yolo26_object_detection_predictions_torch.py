...
def test_torchscript_package_with_static_batch_size_and_letterbox_batch_numpy(
    coin_counting_yolo26n_torch_script_static_bs_letterbox_package: str,
    coins_counting_image_numpy: np.ndarray,
) -> None:
    # given
    model = YOLO26ForObjectDetectionTorchScript.from_pretrained(
        model_name_or_path=coin_counting_yolo26n_torch_script_static_bs_letterbox_package,
...
def test_torch_script_package_with_static_batch_size_and_letterbox__fused_nms_numpy(
    coin_counting_yolo26n_torch_script_static_bs_letterbox_fused_nms_package: str,
    coins_counting_image_numpy: np.ndarray,
) -> None:
    # given
    model = YOLO26ForObjectDetectionTorchScript.from_pretrained(
        model_name_or_path=coin_counting_yolo26n_torch_script_static_bs_letterbox_fused_nms_package,
        device=DEFAULT_DEVICE,
    )
...
def test_torchscript_package_with_static_batch_size_and_static_crop_stretch_numpy(
    coin_counting_yolo26n_torch_script_dynamic_bs_static_crop_stretch_package: str,
    coins_counting_image_numpy: np.ndarray,
) -> None:
    # given
    model = YOLO26ForObjectDetectionTorchScript.from_pretrained(
        model_name_or_path=coin_counting_yolo26n_torch_script_dynamic_bs_static_crop_stretch_package,
        device=DEFAULT_DEVICE,
    )
...
def test_torchscript_package_with_static_batch_size_and_static_crop_stretch_nms_fused_numpy(
    coin_counting_yolo26n_torch_script_static_bs_static_crop_stretch_fused_nms_package: str,
    coins_counting_image_numpy: np.ndarray,
) -> None:
    # given
    model = YOLO26ForObjectDetectionTorchScript.from_pretrained(
        model_name_or_path=coin_counting_yolo26n_torch_script_static_bs_static_crop_stretch_fused_nms_package,
        device=DEFAULT_DEVICE,
    )
...
def test_torchscript_package_with_static_batch_size_and_center_crop_numpy(
    coin_counting_yolo26n_toch_script_static_bs_center_crop_package: str,
    coins_counting_image_numpy: np.ndarray,
) -> None:
    # given
    model = YOLO26ForObjectDetectionTorchScript.from_pretrained(
        model_name_or_path=coin_counting_yolo26n_toch_script_static_bs_center_crop_package,
        device=DEFAULT_DEVICE,
    )
...
def test_torchscript_package_with_static_batch_size_and_center_crop_nms_fused_numpy(
    coin_counting_yolo26n_toch_script_static_bs_center_crop_fused_nms_package: str,
    coins_counting_image_numpy: np.ndarray,
) -> None:
    # given
    model = YOLO26ForObjectDetectionTorchScript.from_pretrained(
        model_name_or_path=coin_counting_yolo26n_toch_script_static_bs_center_crop_fused_nms_package,
        device=DEFAULT_DEVICE,
    )
