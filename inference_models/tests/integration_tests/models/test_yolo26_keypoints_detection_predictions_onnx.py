...
LETTERBOX_EXPECTED_KP_CONF_1 = (
    [0.4832]
    + [0.0] * 6
    + [0.4811, 0.3102, 0.3857, 0.4450, 0.3724]
    + [0.0] * 3
    + [0.3119]
    + [0.0] * 2
    + [0.3165]
...
STRETCH_EXPECTED_KP_CONF = (
    [0.0] * 9 + [0.5310] + [0.0] + [0.3716] + [0.0] * 11 + [0.4403] + [0.0] * 9
)
...
def test_yolo26n_pose_onnx_static_letterbox_batch_numpy(
    ...
    expected_box_conf = torch.tensor([0.9258, 0.5585])
