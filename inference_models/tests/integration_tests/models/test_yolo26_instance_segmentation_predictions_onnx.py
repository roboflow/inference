...
def test_onnx_package_with_dynamic_batch_size_and_stretch_numpy(
    asl_yolo26n_onnx_seg_dynamic_bs_stretch: str,
    ...
    model = YOLO26ForInstanceSegmentationOnnx.from_pretrained(
        model_name_or_path=asl_yolo26n_onnx_seg_dynamic_bs_stretch,
...
def test_onnx_package_with_dynamic_batch_size_and_stretch_fused_nms_numpy(
    asl_yolo26n_onnx_seg_dynamic_bs_stretch_fused_nms: str,
    asl_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_instance_segmentation_onnx import (
    ...
    model = YOLO26ForInstanceSegmentationOnnx.from_pretrained(
        model_name_or_path=asl_yolo26n_onnx_seg_dynamic_bs_stretch_fused_nms,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
...
def test_onnx_package_with_static_batch_size_and_stretch_numpy(
    asl_yolo26n_onnx_seg_static_bs_stretch: str,
    asl_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_instance_segmentation_onnx import (
    ...
    model = YOLO26ForInstanceSegmentationOnnx.from_pretrained(
        model_name_or_path=asl_yolo26n_onnx_seg_static_bs_stretch,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
...
def test_onnx_package_with_dynamic_batch_size_and_static_crop_stretch_numpy(
    asl_yolo26n_onnx_seg_dynamic_bs_static_crop_stretch: str,
    asl_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_instance_segmentation_onnx import (
    ...
    model = YOLO26ForInstanceSegmentationOnnx.from_pretrained(
        model_name_or_path=asl_yolo26n_onnx_seg_dynamic_bs_static_crop_stretch,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
...
def test_onnx_package_with_dynamic_batch_size_and_static_crop_stretch_fused_nms_numpy(
    asl_yolo26n_onnx_seg_dynamic_bs_static_crop_stretch_fused_nms: str,
    asl_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_instance_segmentation_onnx import (
    ...
    model = YOLO26ForInstanceSegmentationOnnx.from_pretrained(
        model_name_or_path=asl_yolo26n_onnx_seg_dynamic_bs_static_crop_stretch_fused_nms,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
...
def test_onnx_package_with_static_batch_size_and_static_crop_stretch_numpy(
    asl_yolo26n_onnx_seg_static_bs_static_crop_stretch: str,
    asl_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_instance_segmentation_onnx import (
    ...
    model = YOLO26ForInstanceSegmentationOnnx.from_pretrained(
        model_name_or_path=asl_yolo26n_onnx_seg_static_bs_static_crop_stretch,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
...
def test_onnx_package_with_dynamic_batch_size_and_static_crop_center_crop_numpy(
    asl_yolo26n_onnx_seg_dynamic_bs_static_crop_center_crop: str,
    asl_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_instance_segmentation_onnx import (
    ...
    model = YOLO26ForInstanceSegmentationOnnx.from_pretrained(
        model_name_or_path=asl_yolo26n_onnx_seg_dynamic_bs_static_crop_center_crop,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
...
def test_onnx_package_with_dynamic_batch_size_and_static_crop_center_crop_fused_nms_numpy(
    asl_yolo26n_onnx_seg_dynamic_bs_static_crop_center_crop_fused_nms: str,
    asl_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_instance_segmentation_onnx import (
    ...
    model = YOLO26ForInstanceSegmentationOnnx.from_pretrained(
        model_name_or_path=asl_yolo26n_onnx_seg_dynamic_bs_static_crop_center_crop_fused_nms,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
...
def test_onnx_package_with_static_batch_size_and_static_crop_center_crop_numpy(
    asl_yolo26n_onnx_seg_static_bs_static_crop_center_crop: str,
    asl_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_instance_segmentation_onnx import (
    ...
    model = YOLO26ForInstanceSegmentationOnnx.from_pretrained(
        model_name_or_path=asl_yolo26n_onnx_seg_static_bs_static_crop_center_crop,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
...
def test_onnx_package_with_dynamic_batch_size_and_center_crop_numpy(
    asl_yolo26n_onnx_seg_dynamic_bs_center_crop: str,
    asl_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_instance_segmentation_onnx import (
    ...
    model = YOLO26ForInstanceSegmentationOnnx.from_pretrained(
        model_name_or_path=asl_yolo26n_onnx_seg_dynamic_bs_center_crop,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
...
def test_onnx_package_with_dynamic_batch_size_and_static_crop_letterbox_numpy(
    asl_yolo26n_onnx_seg_dynamic_bs_static_crop_letterbox: str,
    asl_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_instance_segmentation_onnx import (
    ...
    model = YOLO26ForInstanceSegmentationOnnx.from_pretrained(
        model_name_or_path=asl_yolo26n_onnx_seg_dynamic_bs_static_crop_letterbox,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
