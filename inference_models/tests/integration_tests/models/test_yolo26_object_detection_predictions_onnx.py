...
def test_onnx_package_with_dynamic_batch_size_and_letterbox_numpy(
    coin_counting_yolo26n_onnx_dynamic_bs_letterbox_package: str,
    ...
    model = YOLO26ForObjectDetectionOnnx.from_pretrained(
        model_name_or_path=coin_counting_yolo26n_onnx_dynamic_bs_letterbox_package,
...
def test_onnx_package_with_dynamic_batch_size_and_letterbox_fused_nms_numpy(
    coin_counting_yolo26n_onnx_dynamic_bs_letterbox_fused_nms_package: str,
    coins_counting_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_object_detection_onnx import (
    ...
    model = YOLO26ForObjectDetectionOnnx.from_pretrained(
        model_name_or_path=coin_counting_yolo26n_onnx_dynamic_bs_letterbox_fused_nms_package,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
...
def test_onnx_package_with_static_batch_size_and_letterbox_numpy(
    coin_counting_yolo26n_onnx_static_bs_letterbox_package: str,
    coins_counting_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_object_detection_onnx import (
    ...
    model = YOLO26ForObjectDetectionOnnx.from_pretrained(
        model_name_or_path=coin_counting_yolo26n_onnx_static_bs_letterbox_package,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
...
def test_onnx_package_with_dynamic_batch_size_and_static_crop_stretch_numpy(
    coin_counting_yolo26n_onnx_dynamic_bs_static_crop_stretch_package: str,
    coins_counting_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_object_detection_onnx import (
    ...
    model = YOLO26ForObjectDetectionOnnx.from_pretrained(
        model_name_or_path=coin_counting_yolo26n_onnx_dynamic_bs_static_crop_stretch_package,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
...
def test_onnx_package_with_dynamic_batch_size_and_static_crop_stretch_nms_fused_numpy(
    coin_counting_yolo26n_onnx_dynamic_bs_static_crop_stretch_nms_fused_package: str,
    coins_counting_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_object_detection_onnx import (
    ...
    model = YOLO26ForObjectDetectionOnnx.from_pretrained(
        model_name_or_path=coin_counting_yolo26n_onnx_dynamic_bs_static_crop_stretch_nms_fused_package,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
...
def test_onnx_package_with_static_batch_size_and_static_crop_stretch_numpy(
    coin_counting_yolo26n_onnx_static_bs_static_crop_stretch_package: str,
    coins_counting_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_object_detection_onnx import (
    ...
    model = YOLO26ForObjectDetectionOnnx.from_pretrained(
        model_name_or_path=coin_counting_yolo26n_onnx_static_bs_static_crop_stretch_package,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
...
def test_onnx_package_with_dynamic_batch_size_and_center_crop_numpy(
    coin_counting_yolo26n_onnx_dynamic_bs_center_crop_package: str,
    coins_counting_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_object_detection_onnx import (
    ...
    model = YOLO26ForObjectDetectionOnnx.from_pretrained(
        model_name_or_path=coin_counting_yolo26n_onnx_dynamic_bs_center_crop_package,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
...
def test_onnx_package_with_dynamic_batch_size_and_center_crop_fused_nms_numpy(
    coin_counting_yolo26n_onnx_dynamic_bs_center_crop_fused_nms_package: str,
    coins_counting_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_object_detection_onnx import (
    ...
    model = YOLO26ForObjectDetectionOnnx.from_pretrained(
        model_name_or_path=coin_counting_yolo26n_onnx_dynamic_bs_center_crop_fused_nms_package,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
...
def test_onnx_package_with_static_batch_size_and_center_crop_numpy(
    coin_counting_yolo26n_onnx_static_bs_center_crop_package: str,
    coins_counting_image_numpy: np.ndarray,
) -> None:
    # given
    from inference_models.models.yolo26.yolo26_object_detection_onnx import (
    ...
    model = YOLO26ForObjectDetectionOnnx.from_pretrained(
        model_name_or_path=coin_counting_yolo26n_onnx_static_bs_center_crop_package,
        onnx_execution_providers=["CUDAExecutionProvider", "CPUExecutionProvider"],
    )
