...
def test_torchscript_package_with_static_batch_size_and_stretch_numpy(
    asl_yolo26n_torchscript_seg_static_bs_stretch: str,
    asl_image_numpy: np.ndarray,
) -> None:
    # given
    model = YOLO26ForInstanceSegmentationTorchScript.from_pretrained(
        model_name_or_path=asl_yolo26n_torchscript_seg_static_bs_stretch,
...
def test_torchscript_package_with_static_batch_size_and_stretch_fused_nms_numpy(
    asl_yolo26n_torchscript_seg_static_bs_stretch_fused_nms: str,
    asl_image_numpy: np.ndarray,
) -> None:
    # given
    model = YOLO26ForInstanceSegmentationTorchScript.from_pretrained(
        model_name_or_path=asl_yolo26n_torchscript_seg_static_bs_stretch_fused_nms,
        device=DEFAULT_DEVICE,
    )
...
def test_torchscript_package_with_static_batch_size_and_static_crop_stretch_numpy(
    asl_yolo26n_torchscript_seg_static_bs_static_crop_stretch: str,
    asl_image_numpy: np.ndarray,
) -> None:
    # given
    model = YOLO26ForInstanceSegmentationTorchScript.from_pretrained(
        model_name_or_path=asl_yolo26n_torchscript_seg_static_bs_static_crop_stretch,
        device=DEFAULT_DEVICE,
    )
...
def test_torchscript_package_with_static_batch_size_and_static_crop_stretch_fused_nms_numpy(
    asl_yolo26n_torchscript_seg_static_bs_static_crop_stretch_fused_nms: str,
    asl_image_numpy: np.ndarray,
) -> None:
    # given
    model = YOLO26ForInstanceSegmentationTorchScript.from_pretrained(
        model_name_or_path=asl_yolo26n_torchscript_seg_static_bs_static_crop_stretch_fused_nms,
        device=DEFAULT_DEVICE,
    )
...
def test_torchscript_package_with_static_batch_size_and_static_crop_center_crop_numpy(
    asl_yolo26n_torchscript_seg_static_bs_static_crop_center_crop: str,
    asl_image_numpy: np.ndarray,
) -> None:
    # given
    model = YOLO26ForInstanceSegmentationTorchScript.from_pretrained(
        model_name_or_path=asl_yolo26n_torchscript_seg_static_bs_static_crop_center_crop,
        device=DEFAULT_DEVICE,
    )
...
def test_torchscript_package_with_static_batch_size_and_center_crop_numpy(
    asl_yolo26n_torchscript_seg_static_bs_center_crop: str,
    asl_image_numpy: np.ndarray,
) -> None:
    # given
    model = YOLO26ForInstanceSegmentationTorchScript.from_pretrained(
        model_name_or_path=asl_yolo26n_torchscript_seg_static_bs_center_crop,
        device=DEFAULT_DEVICE,
    )
...
def test_torchscript_package_with_static_batch_size_and_static_crop_letterbox_crop_numpy(
    asl_yolo26n_torchscript_seg_static_bs_static_crop_letterbox: str,
    asl_image_numpy: np.ndarray,
) -> None:
    # given
    model = YOLO26ForInstanceSegmentationTorchScript.from_pretrained(
        model_name_or_path=asl_yolo26n_torchscript_seg_static_bs_static_crop_letterbox,
        device=DEFAULT_DEVICE,
    )
