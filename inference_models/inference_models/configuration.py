...
INFERENCE_MODELS_YOLO_PACKED_RESCALE_ENABLED = get_boolean_from_env(
    variable_name="INFERENCE_MODELS_YOLO_PACKED_RESCALE_ENABLED",
    default=False,
)
INFERENCE_MODELS_YOLO_ULTRALYTICS_SKIP_EMPTY_NMS_CHECK_ENABLED = get_boolean_from_env(
    variable_name="INFERENCE_MODELS_YOLO_ULTRALYTICS_SKIP_EMPTY_NMS_CHECK_ENABLED",
    default=False,
)
