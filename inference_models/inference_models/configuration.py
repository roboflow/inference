...
MODEL_BLOB_CACHE_BUCKET = os.getenv("MODEL_BLOB_CACHE_BUCKET")
MODEL_BLOB_CACHE_PREFIX = os.getenv("MODEL_BLOB_CACHE_PREFIX", "model-blobs")
MODEL_BLOB_CACHE_ENDPOINT_URL = os.getenv("MODEL_BLOB_CACHE_ENDPOINT_URL")
MODEL_BLOB_CACHE_REGION = os.getenv("MODEL_BLOB_CACHE_REGION")
MODEL_BLOB_CACHE_ACCESS_KEY_ID = os.getenv("MODEL_BLOB_CACHE_ACCESS_KEY_ID")
MODEL_BLOB_CACHE_SECRET_ACCESS_KEY = os.getenv("MODEL_BLOB_CACHE_SECRET_ACCESS_KEY")
MODEL_BLOB_CACHE_ADDRESSING_STYLE = os.getenv(
    "MODEL_BLOB_CACHE_ADDRESSING_STYLE", "auto"
)
MODEL_BLOB_CACHE_CONNECT_TIMEOUT_SECONDS = get_float_from_env(
    variable_name="MODEL_BLOB_CACHE_CONNECT_TIMEOUT_SECONDS", default=1.0
)
MODEL_BLOB_CACHE_READ_TIMEOUT_SECONDS = get_float_from_env(
    variable_name="MODEL_BLOB_CACHE_READ_TIMEOUT_SECONDS", default=2.0
)
MODEL_BLOB_CACHE_DOWNLOAD_TIMEOUT_SECONDS = get_float_from_env(
    variable_name="MODEL_BLOB_CACHE_DOWNLOAD_TIMEOUT_SECONDS", default=30.0
)
MODEL_BLOB_CACHE_FAILURE_THRESHOLD = get_integer_from_env(
    variable_name="MODEL_BLOB_CACHE_FAILURE_THRESHOLD", default=3
)
MODEL_BLOB_CACHE_COOLDOWN_SECONDS = get_float_from_env(
    variable_name="MODEL_BLOB_CACHE_COOLDOWN_SECONDS", default=60.0
)
