...
INFERENCE_MODELS_FALCON_PERCEPTION_DEFAULT_MASK_THRESHOLD = get_float_from_env(
    variable_name="INFERENCE_MODELS_FALCON_PERCEPTION_DEFAULT_MASK_THRESHOLD",
    default=0.3,
)
INFERENCE_MODELS_FALCON_PERCEPTION_DEFAULT_MAX_NEW_TOKENS = get_integer_from_env(
    variable_name="INFERENCE_MODELS_FALCON_PERCEPTION_DEFAULT_MAX_NEW_TOKENS",
    default=2048,
)
INFERENCE_MODELS_FALCON_PERCEPTION_DEFAULT_MIN_IMAGE_SIZE = get_integer_from_env(
    variable_name="INFERENCE_MODELS_FALCON_PERCEPTION_DEFAULT_MIN_IMAGE_SIZE",
    default=256,
)
INFERENCE_MODELS_FALCON_PERCEPTION_DEFAULT_MAX_IMAGE_SIZE = get_integer_from_env(
    variable_name="INFERENCE_MODELS_FALCON_PERCEPTION_DEFAULT_MAX_IMAGE_SIZE",
    default=1024,
)
