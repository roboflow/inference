        ...
        *,
        ...
        Args:
            execution_plan: Explicit composed plan or canonical serialized mapping.
                When omitted, stage IDs and the fallback policy are read from the
                RF-DETR environment variables; both fallback flags default to
                ``True`` so a bare environment keeps the permissive behaviour.
        ...
        if execution_plan is not None:
            ...
            plan = cls(
                ...
                allow_runtime_failure_fallback=get_boolean_from_env(
                    RFDETR_ALLOW_RUNTIME_FAILURE_FALLBACK_ENV_NAME, default=True
                ),
            )
