...
def load_pillow_simd_image() -> ModuleType:
    ...
    Returns:
        Isolated Pillow-SIMD Image module, leaving standard Pillow untouched.

    Raises:
        ImportError: If the host or configured native build is unsupported.
    """
    ...
    with _LOAD_LOCK:
        image = _load_image(str(Path(root).resolve()))
