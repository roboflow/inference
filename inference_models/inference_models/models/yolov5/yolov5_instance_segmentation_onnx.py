...
try:
    ...
    raise MissingDependencyError(
        message="Running YOLOv5 model with ONNX backend requires pycuda installation, which is brought with "
        ...
        inference_config = parse_inference_config(
            ...
            implicit_resize_mode_substitutions={
                ResizeMode.FIT_LONGER_EDGE: (
                    ResizeMode.LETTERBOX,
                    127,
                    "YOLOv5 Instance Segmentation model running with ONNX backend was trained with "
