...
- MQTT Writer connects with a 15 s keepalive instead of paho's 60 s default, so a broker that disappears without closing the connection is reported within about 25 s.
