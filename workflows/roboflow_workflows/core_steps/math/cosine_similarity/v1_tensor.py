...
class BlockManifest(WorkflowBlockManifest):
    ...
    embedding_1: Selector(kind=[TENSOR_NATIVE_EMBEDDING_KIND]) = Field(
    ...
    embedding_2: Selector(kind=[TENSOR_NATIVE_EMBEDDING_KIND]) = Field(
    ...
    def discover_work_operations(self) -> List[WorkOperation]:
        return [WorkOperation.NUMERICAL_COMPUTATION]
