...
[Roboflow Cloud products](https://docs.roboflow.com/deployment/roboflow-cloud/serverless-api), including the Serverless Cloud API, include a commercial license for all models for every user. A commercial license for self-hosted deployment of these models is available as an [Enterprise add-on](https://roboflow.com/licensing). A custom contract can include it as well. Without that add-on or contract, self-hosted deployment follows the model's own license. An AGPL-3.0 model must be used under AGPL-3.0. It is your responsibility to ensure your code's compliance with the models you use.