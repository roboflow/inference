...
from roboflow_workflows.utils.images import encode_image_to_jpeg_bytes, load_image
...
class BlockManifest(WorkflowBlockManifest):
    model_config = ConfigDict(
        json_schema_extra={
            ...
            "block_type": "model",
            "search_keywords": ["LMM", "VLM", "Qwen", "Qwen 3.6", "OpenRouter"],
            "is_vlm_block": True,
    ...
    type: Literal["roboflow_core/qwen3_6_openrouter@v1"]
    ...
    prompt: Optional[Union[Selector(kind=[STRING_KIND]), str]] = Field(
        default=None,
        description="Text prompt to the Qwen 3.6 model",
    ...
    model_version: Union[
        ...
        examples=["Qwen 3.6 35B A3B - OpenRouter", "$inputs.qwen_model"],
    )
...
class Qwen36OpenRouterBlockV1(WorkflowBlock):
