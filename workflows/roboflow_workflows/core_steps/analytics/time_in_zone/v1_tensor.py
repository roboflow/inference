...
from roboflow_workflows.core_steps.analytics._zone_geometry import (
    LeanPolygonZone,
...
class TimeInZoneBlockV1(WorkflowBlock):
    def __init__(self):
        ...
        self._batch_of_polygon_zones: Dict[str, LeanPolygonZone] = {}
    ...
    def run(
        ...
        if metadata.video_identifier not in self._batch_of_polygon_zones:
            ...
            self._batch_of_polygon_zones[metadata.video_identifier] = LeanPolygonZone(
