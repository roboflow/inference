...
from roboflow_workflows.core_steps.visualizations.common.annotators.model_comparison import (
...
class ModelComparisonVisualizationBlockV1(PredictionsVisualizationBlock):
    ...
    def run(
        ...
        predictions_a: Union[TensorNativePrediction, TensorNativeDetections],
        color_a: str,
        predictions_b: Union[TensorNativePrediction, TensorNativeDetections],
        color_b: str,
        background_color: str,
        opacity: Optional[float],
        copy_image: bool,
    ) -> BlockResult:
        predictions_a = to_supervision_for_annotation(predictions_a)
        predictions_b = to_supervision_for_annotation(predictions_b)
