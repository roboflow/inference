...
import numpy as np
import requests
from roboflow_workflows._compat_names import get_logger, historic_type_display
...
from roboflow_workflows.errors import DynamicBlockCodeError, DynamicBlockError
from roboflow_workflows.execution_engine.entities.base import ParentOrigin
...
from roboflow_workflows.execution_engine.v1.dynamic_blocks.entities import PythonCode
...
from roboflow_workflows.utils.images import encode_image_to_jpeg_bytes
...
def _raise_on_unconverted_tensor_native_value(obj: Any) -> None:
    ...
    raise representation_boundary.RepresentationBoundaryError(
        public_message=(
            ...
            f"`{historic_type_display(offending_type)}` reached the "
...
def _serialize_image_for_msgpack(image: Any) -> dict:
    ...
    from roboflow_workflows.environment import WEBEXEC_JPEG_QUALITY
    from roboflow_workflows.execution_engine.entities.base import ParentOrigin
    from roboflow_workflows.utils.images import encode_image_to_jpeg_bytes
...
class WebSocketModalExecutor:
    ...
    def execute_remote(
        ...
        if not workspace or workspace in (
            ...
            from roboflow_workflows.environment import MODAL_ALLOW_ANONYMOUS_EXECUTION
...
def get_modal_executor(workspace_id: Optional[str] = None) -> Any:
    ...
    from roboflow_workflows.environment import WEBEXEC_TRANSPORT
