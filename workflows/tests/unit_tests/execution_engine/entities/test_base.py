...
import numpy as np
import pytest
from roboflow_workflows.execution_engine.entities import base
...
from roboflow_workflows.environment import (  # noqa: E402
...
def test_local_file_reference_is_refused_when_no_host_codec_is_installed(
    ...
    from roboflow_workflows.prototypes.image_codec import reset_image_codec
