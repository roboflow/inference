...
def test_build_human_friendly_block_name_when_overridden_in_schema() -> None:
    ...
    result = build_human_friendly_block_name(
        fully_qualified_name="roboflow_workflows.core_steps.transformations.crop.MyCropBlock",
...
def test_build_human_friendly_block_name_when_block_suffix_present() -> None:
    # when
    result = build_human_friendly_block_name(
        fully_qualified_name="roboflow_workflows.core_steps.transformations.dynamic_crop.MyCropBlock"
    )
...
def test_build_human_friendly_block_name_when_acronym_and_block_suffix_present() -> (
    ...
    # when
    result = build_human_friendly_block_name(
        fully_qualified_name="roboflow_workflows.core_steps.example.OCRResultsParserBlock"
    )
...
def test_build_human_friendly_block_name_when_underscores_separate_segments() -> None:
    # when
    result = build_human_friendly_block_name(
        fully_qualified_name="roboflow_workflows.core_steps.example.OCR_Results_Parser"
    )
...
def test_build_human_friendly_block_name_when_underscores_and_block_suffix_present() -> (
    ...
    # when
    result = build_human_friendly_block_name(
        fully_qualified_name="roboflow_workflows.core_steps.example.OCR_Results_Parser_Block"
    )
...
def test_build_human_friendly_block_name_when_block_suffix_not_present() -> None:
    # when
    result = build_human_friendly_block_name(
        fully_qualified_name="roboflow_workflows.core_steps.transformations.dynamic_crop.MyCrop"
    )
