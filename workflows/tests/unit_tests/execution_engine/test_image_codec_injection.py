...
import numpy as np
import pytest
from roboflow_workflows.core_steps.loader import KINDS_DESERIALIZERS
...
def test_shared_registry_is_not_disturbed_by_engine_scoped_injection() -> None:
    ...
    from roboflow_workflows.prototypes.image_codec import get_image_codec
...
def test_a_plugin_deserializer_without_the_parameter_is_left_alone() -> None:
    ...
    from roboflow_workflows.execution_engine.v1 import core as v1_core
