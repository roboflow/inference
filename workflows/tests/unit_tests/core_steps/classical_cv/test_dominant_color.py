...
def _tensor_dominant_color_imports():
    ...
    from roboflow_workflows.core_steps.classical_cv.dominant_color import v1_tensor
...
def test_tensor_dominant_color_on_mps_device(monkeypatch) -> None:
    ...
    import roboflow_workflows.execution_engine.entities.base as base_module
