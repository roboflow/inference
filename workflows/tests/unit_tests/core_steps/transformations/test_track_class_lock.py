...
def test_track_class_lock_new_ids_do_not_trigger_quadratic_scan() -> None:
    ...
    from roboflow_workflows.core_steps.transformations import track_class_lock
...
def test_track_class_lock_tensor_variant_bounds_per_track_class_state() -> None:
    ...
    from roboflow_workflows.core_steps.transformations.track_class_lock import v1_tensor
