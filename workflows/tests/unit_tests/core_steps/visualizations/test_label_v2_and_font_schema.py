...
import torch
from roboflow_workflows.core_steps.visualizations.common.fonts.registry import (
    FONTS_REGISTRY,
)
...
from roboflow_workflows.core_steps.visualizations.rich_label.v1 import RichLabelManifest
...
def test_label_v2_center_of_mass_with_rle_masks() -> None:
    ...
    output = LabelVisualizationBlockV2().run(
        image=WorkflowImageData(
            parent_metadata=ImageParentMetadata(parent_id="some"),
