...
@patch(
    "roboflow_workflows.core_steps.models.foundation.anthropic_claude.v2.anthropic.Anthropic"
)
...
@patch(
    "roboflow_workflows.core_steps.models.foundation.anthropic_claude.v1.anthropic.Anthropic"
)
...
def test_direct_request_keeps_legacy_controls_for_legacy_model(
    ...
    with patch(
        f"roboflow_workflows.core_steps.models.foundation.anthropic_claude.{module}.anthropic.Anthropic"
