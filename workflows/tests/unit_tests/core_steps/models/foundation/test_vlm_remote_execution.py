...
class TestFlorence2Remote:
    ...
    @patch(
        "roboflow_workflows.core_steps.models.foundation.florence2.v1.InferenceHTTPClient"
    )
...
class TestMoondream2Remote:
    ...
    @patch(
        "roboflow_workflows.core_steps.models.foundation.moondream2.v1.InferenceHTTPClient"
    )
    def test_run_remotely_calls_infer_lmm(
        self, mock_client_cls, mock_model_manager, mock_workflow_image_data
    ):
...
class TestSmolVLMRemote:
    ...
    @patch(
        "roboflow_workflows.core_steps.models.foundation.smolvlm.v1.InferenceHTTPClient"
    )
    def test_run_remotely_calls_infer_lmm(
        self, mock_client_cls, mock_model_manager, mock_workflow_image_data
    ):
...
class TestGLMOCRRemote:
    ...
    @patch(
        "roboflow_workflows.core_steps.models.foundation.glm_ocr.v1.InferenceHTTPClient"
    )
    def test_run_remotely_forwards_max_new_tokens(
        self, mock_client_cls, mock_model_manager, mock_workflow_image_data
    ):
        from roboflow_workflows.core_steps.models.foundation.glm_ocr.v1 import (
            GLMOCRBlockV1,
        )
...
class TestQwen25VLRemote:
    ...
    @patch(
        "roboflow_workflows.core_steps.models.foundation.qwen.v1.InferenceHTTPClient"
    )
    def test_run_remotely_calls_infer_lmm(
        self, mock_client_cls, mock_model_manager, mock_workflow_image_data
    ):
        from roboflow_workflows.core_steps.models.foundation.qwen.v1 import (
            Qwen25VLBlockV1,
        )
...
class TestQwen35VLRemote:
    ...
    @patch(
        "roboflow_workflows.core_steps.models.foundation.qwen3_5vl.v1.InferenceHTTPClient"
    )
...
class TestQwen35VLRemoteV2:
    ...
    @patch(
        "roboflow_workflows.core_steps.models.foundation.qwen3_5vl.v2.InferenceHTTPClient"
    )
    def test_run_remotely_forwards_generation_parameters(
        self, mock_client_cls, mock_model_manager, mock_workflow_image_data
    ):
...
class TestQwen3VLRemote:
    ...
    @patch(
        "roboflow_workflows.core_steps.models.foundation.qwen3vl.v1.InferenceHTTPClient"
    )
    def test_run_remotely_calls_infer_lmm(
        self, mock_client_cls, mock_model_manager, mock_workflow_image_data
    ):
