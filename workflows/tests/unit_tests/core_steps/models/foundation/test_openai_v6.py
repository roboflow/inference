...
import pytest
from roboflow_workflows.core_steps.models.foundation.openai.v6 import (
...
@patch("roboflow_workflows.core_steps.models.foundation.openai.v6._get_openai_client")
