...
from roboflow_workflows.core_steps.models.foundation.qwen_vlm import v2
...
@patch(
    "roboflow_workflows.core_steps.models.foundation.qwen_vlm.v2.InferenceHTTPClient"
)
