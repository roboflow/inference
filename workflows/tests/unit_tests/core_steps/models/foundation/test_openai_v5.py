...
from roboflow_workflows.core_steps.models.foundation.openai.v5 import (
...
def test_execute_openai_request_routes_to_proxy_for_rf_key_account() -> None:
    # given
    with patch(
        "roboflow_workflows.core_steps.models.foundation.openai.v5._execute_proxied_openai_request"
    ) as mock_proxy:
...
def test_execute_openai_request_routes_to_direct_for_regular_api_key() -> None:
    # given
    with patch(
        "roboflow_workflows.core_steps.models.foundation.openai.v5._execute_direct_openai_request"
    ) as mock_direct:
...
@patch("roboflow_workflows.core_steps.models.foundation.openai.v5._get_openai_client")
