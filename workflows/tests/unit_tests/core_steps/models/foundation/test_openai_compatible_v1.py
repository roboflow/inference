...
from roboflow_workflows.core_steps.models.foundation.openai_compatible import (
...
@patch(
    "roboflow_workflows.core_steps.models.foundation.openai_compatible.v1._execute_request"
)
@patch.object(
    openai_compatible,
...
@patch("roboflow_workflows.core_steps.models.foundation.openai_compatible.v1.OpenAI")
