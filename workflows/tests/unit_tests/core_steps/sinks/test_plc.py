...
from roboflow_workflows.enterprise_blocks.sinks.plc.client import relay_base_url
from roboflow_workflows.enterprise_blocks.sinks.plc.direct import _parse_modbus_tag
...
V1 = "roboflow_workflows.enterprise_blocks.sinks.plc.v1"
CLIENT = "roboflow_workflows.enterprise_blocks.sinks.plc.client"
DIRECT = "roboflow_workflows.enterprise_blocks.sinks.plc.direct"
...
def test_blocks_registered_and_old_deprecated():
    ...
    from roboflow_workflows.enterprise_blocks.sinks.PLCethernetIP.v1 import (
        PLCBlockManifest,
    )
