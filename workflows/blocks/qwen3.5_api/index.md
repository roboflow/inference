...
??? "Class: `Qwen35OpenRouterBlockV1`"

    Source:
    <a target="_blank" href="https://github.com/roboflow/inference/blob/main/inference/core/workflows/core_steps/models/foundation/qwen3_5_openrouter/v1.py">inference.core.workflows.core_steps.models.foundation.qwen3_5_openrouter.v1.Qwen35OpenRouterBlockV1</a>
...
Use the following identifier in step `"type"` field: `roboflow_core/qwen3_5_openrouter@v1`to add the block as
...
| `prompt` | `str` | Text prompt to the Qwen 3.5 model. | ✅ |
...
??? tip "Compatible Blocks"
    Check what blocks you can connect to `Qwen 3.5 API` in version `v1`.
...
`Qwen 3.5 API` in version `v1`  has.
...
???+ tip "Bindings"
    ...
    - input
        ...
        - `prompt` (*[`string`](../kinds/string.md)*): Text prompt to the Qwen 3.5 model.
...
??? tip "Example JSON definition of step `Qwen 3.5 API` in version `v1`"
