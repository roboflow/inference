...
???+ tip "Bindings"
    ...
    - input
        ...
        - `attachments` (*Union[[`string`](../kinds/string.md), [`bytes`](../kinds/bytes.md), [`image`](../kinds/image.md)]*): Attachments.
