...
??? tip "Compatible Blocks"
    ...
    - outputs: [`PLC EthernetIP`](plc_ethernet_ip.md), [`SAM 3`](sam3.md), [`Detections Consensus`](detections_consensus.md), [`Microsoft SQL Server Sink`](microsoft_sql_server_sink.md), [`Roboflow Asset Library Attributes`](roboflow_asset_library_attributes.md), [`Per-Class Confidence Filter`](per_class_confidence_filter.md)
