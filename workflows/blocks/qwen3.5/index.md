...
??? tip "Compatible Blocks"
    ...
    - outputs: [`Microsoft SQL Server Sink`](microsoft_sql_server_sink.md), [`PLC EthernetIP`](plc_ethernet_ip.md), [`Per-Class Confidence Filter`](per_class_confidence_filter.md), [`Roboflow Asset Library Attributes`](roboflow_asset_library_attributes.md), [`SAM 3`](sam3.md), [`Detections Consensus`](detections_consensus.md)
