...
??? tip "Compatible Blocks"
    ...
    - outputs: [`Detections Consensus`](detections_consensus.md), [`Roboflow Asset Library Attributes`](roboflow_asset_library_attributes.md), [`SAM 3`](sam3.md), [`Per-Class Confidence Filter`](per_class_confidence_filter.md)
