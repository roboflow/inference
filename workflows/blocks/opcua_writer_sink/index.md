...
???+ tip "Bindings"
    ...
    - input
        ...
        - `value` (*Union[[`integer`](../kinds/integer.md), [`string`](../kinds/string.md), [`float`](../kinds/float.md), [`boolean`](../kinds/boolean.md)]*): The value to be written to the target variable on the OPC UA server..
