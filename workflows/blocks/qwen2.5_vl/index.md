...
??? tip "Compatible Blocks"
    ...
    - outputs: [`SAM 3`](sam3.md), [`Per-Class Confidence Filter`](per_class_confidence_filter.md), [`Roboflow Asset Library Attributes`](roboflow_asset_library_attributes.md), [`Detections Consensus`](detections_consensus.md), [`Microsoft SQL Server Sink`](microsoft_sql_server_sink.md), [`PLC EthernetIP`](plc_ethernet_ip.md)
