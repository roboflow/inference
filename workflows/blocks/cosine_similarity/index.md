...
??? tip "Compatible Blocks"
    ...
    - inputs: [`Identify Changes`](identify_changes.md), [`Perception Encoder Embedding Model`](perception_encoder_embedding_model.md), [`CLIP Embedding Model`](clip_embedding_model.md)
    - outputs: [`Webhook Sink`](webhook_sink.md), [`Detection Event Log`](detection_event_log.md), [`OpenAI-Compatible LLM`](open_ai_compatible_llm.md), [`Line Counter Visualization`](line_counter_visualization.md), [`Anthropic Claude`](anthropic_claude.md), [`Seg Preview`](seg_preview.md), [`OpenAI`](open_ai.md), [`SAM 3`](sam3.md), [`Segment Anything 2 Model`](segment_anything2_model.md), [`Keypoint Visualization`](keypoint_visualization.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Text Display`](text_display.md), [`Template Matching`](template_matching.md), [`Qwen 3.5 API`](qwen3.5_api.md), [`Mask Area Measurement`](mask_area_measurement.md), [`Velocity`](velocity.md), [`Anthropic Claude`](anthropic_claude.md), [`MQTT Writer`](mqtt_writer.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`Google Gemini`](google_gemini.md), [`Camera Calibration`](camera_calibration.md), [`SAM 3`](sam3.md), [`PTZ Tracking (ONVIF)`](ptz_tracking(onvif).md), [`Qwen-VL`](qwen_vl.md), [`Crop Visualization`](crop_visualization.md), [`Google Gemma API`](google_gemma_api.md), [`Google Gemma`](google_gemma.md), [`SAM 3`](sam3.md), [`OPC UA Writer Sink`](opcua_writer_sink.md), [`Detections List Roll-Up`](detections_list_roll_up.md), [`OpenRouter`](open_router.md), [`Roboflow Dataset Upload`](roboflow_dataset_upload.md), [`Distance Measurement`](distance_measurement.md), [`Mask Edge Snap`](mask_edge_snap.md), [`Google Gemini`](google_gemini.md), [`Heatmap Visualization`](heatmap_visualization.md), [`OpenAI`](open_ai.md), [`Qwen 3.6 API`](qwen3.6_api.md), [`SAM2 Video Tracker`](sam2_video_tracker.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`Continue If`](continue_if.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Label Visualization`](label_visualization.md), [`Stitch OCR Detections`](stitch_ocr_detections.md), [`Google Gemini`](google_gemini.md), [`OpenAI`](open_ai.md), [`Anthropic Claude`](anthropic_claude.md), [`Dynamic Zone`](dynamic_zone.md)
