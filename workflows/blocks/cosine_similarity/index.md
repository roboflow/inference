...
??? tip "Compatible Blocks"
    ...
    - outputs: [`Google Gemini`](google_gemini.md), [`OpenAI`](open_ai.md), [`SAM 3`](sam3.md), [`SAM 3 Interactive`](sam3_interactive.md), [`Anthropic Claude`](anthropic_claude.md), [`Qwen-VL`](qwen_vl.md), [`Qwen 3.5 API`](qwen3.5_api.md), [`Mask Area Measurement`](mask_area_measurement.md), [`Google Gemma`](google_gemma.md), [`Crop Visualization`](crop_visualization.md), [`Detections List Roll-Up`](detections_list_roll_up.md), [`Anthropic Claude`](anthropic_claude.md), [`Heatmap Visualization`](heatmap_visualization.md), [`Mask Edge Snap`](mask_edge_snap.md), [`Velocity`](velocity.md), [`Webhook Sink`](webhook_sink.md), [`Google Gemma API`](google_gemma_api.md), [`Template Matching`](template_matching.md), [`OpenAI`](open_ai.md), [`SAM3 Video Tracker`](sam3_video_tracker.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`Detection Event Log`](detection_event_log.md), [`Segment Anything 2 Model`](segment_anything2_model.md), [`SAM 3`](sam3.md), [`SAM 3`](sam3.md), [`OpenAI`](open_ai.md), [`OPC UA Writer Sink`](opcua_writer_sink.md), [`Google Gemini`](google_gemini.md), [`OpenAI-Compatible LLM`](open_ai_compatible_llm.md), [`Distance Measurement`](distance_measurement.md), [`Anthropic Claude`](anthropic_claude.md), [`Stitch OCR Detections`](stitch_ocr_detections.md), [`GeoTag Detection`](geo_tag_detection.md), [`Keypoint Visualization`](keypoint_visualization.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Label Visualization`](label_visualization.md), [`Dynamic Zone`](dynamic_zone.md), [`Auto Rotate on Edges`](auto_rotateon_edges.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Qwen 3.6 API`](qwen3.6_api.md), [`Text Display`](text_display.md), [`PTZ Tracking (ONVIF)`](ptz_tracking(onvif).md), [`MQTT Writer`](mqtt_writer.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`Roboflow Dataset Upload`](roboflow_dataset_upload.md), [`OpenRouter`](open_router.md), [`Roboflow Vision Events`](roboflow_vision_events.md), [`Continue If`](continue_if.md), [`Line Counter Visualization`](line_counter_visualization.md), [`Camera Calibration`](camera_calibration.md), [`Google Gemini`](google_gemini.md), [`SAM2 Video Tracker`](sam2_video_tracker.md), [`Seg Preview`](seg_preview.md)
