...
??? tip "Compatible Blocks"
    ...
    - outputs: [`OpenAI`](open_ai.md), [`SAM 3`](sam3.md), [`SAM 3`](sam3.md), [`Qwen-VL`](qwen_vl.md), [`OpenRouter`](open_router.md), [`OpenAI`](open_ai.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Line Counter Visualization`](line_counter_visualization.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`Stitch OCR Detections`](stitch_ocr_detections.md), [`Dynamic Zone`](dynamic_zone.md), [`Anthropic Claude`](anthropic_claude.md), [`OpenAI-Compatible LLM`](open_ai_compatible_llm.md), [`OpenAI`](open_ai.md), [`Segment Anything 2 Model`](segment_anything2_model.md), [`Mask Area Measurement`](mask_area_measurement.md), [`Heatmap Visualization`](heatmap_visualization.md), [`Keypoint Visualization`](keypoint_visualization.md), [`Roboflow Dataset Upload`](roboflow_dataset_upload.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Anthropic Claude`](anthropic_claude.md), [`Google Gemini`](google_gemini.md), [`Seg Preview`](seg_preview.md), [`Detections List Roll-Up`](detections_list_roll_up.md), [`SAM 3`](sam3.md), [`Label Visualization`](label_visualization.md), [`Camera Calibration`](camera_calibration.md), [`Distance Measurement`](distance_measurement.md), [`Continue If`](continue_if.md), [`PTZ Tracking (ONVIF)`](ptz_tracking(onvif).md), [`Google Gemini`](google_gemini.md), [`Crop Visualization`](crop_visualization.md), [`Text Display`](text_display.md), [`Google Gemma API`](google_gemma_api.md), [`Qwen 3.6 API`](qwen3.6_api.md), [`Detection Event Log`](detection_event_log.md), [`Mask Edge Snap`](mask_edge_snap.md), [`Template Matching`](template_matching.md), [`Qwen 3.5 API`](qwen3.5_api.md), [`Google Gemini`](google_gemini.md), [`SAM2 Video Tracker`](sam2_video_tracker.md), [`Webhook Sink`](webhook_sink.md), [`Velocity`](velocity.md), [`Anthropic Claude`](anthropic_claude.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`Google Gemma`](google_gemma.md)
