...
??? tip "Compatible Blocks"
    ...
    - inputs: [`Perception Encoder Embedding Model`](perception_encoder_embedding_model.md), [`Identify Changes`](identify_changes.md), [`CLIP Embedding Model`](clip_embedding_model.md)
    - outputs: [`Detections List Roll-Up`](detections_list_roll_up.md), [`Segment Anything 2 Model`](segment_anything2_model.md), [`Template Matching`](template_matching.md), [`Google Gemini`](google_gemini.md), [`OpenAI-Compatible LLM`](open_ai_compatible_llm.md), [`PTZ Tracking (ONVIF)`](ptz_tracking(onvif).md), [`SAM 3`](sam3.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`Crop Visualization`](crop_visualization.md), [`Qwen-VL`](qwen_vl.md), [`Seg Preview`](seg_preview.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`Stitch OCR Detections`](stitch_ocr_detections.md), [`Google Gemma API`](google_gemma_api.md), [`Velocity`](velocity.md), [`Heatmap Visualization`](heatmap_visualization.md), [`Roboflow Dataset Upload`](roboflow_dataset_upload.md), [`Qwen 3.5 API`](qwen3.5_api.md), [`Anthropic Claude`](anthropic_claude.md), [`Anthropic Claude`](anthropic_claude.md), [`Qwen 3.6 API`](qwen3.6_api.md), [`Label Visualization`](label_visualization.md), [`OpenAI`](open_ai.md), [`Webhook Sink`](webhook_sink.md), [`SAM2 Video Tracker`](sam2_video_tracker.md), [`Keypoint Visualization`](keypoint_visualization.md), [`Google Gemini`](google_gemini.md), [`SAM 3`](sam3.md), [`Google Gemma`](google_gemma.md), [`Detection Event Log`](detection_event_log.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Camera Calibration`](camera_calibration.md), [`OpenAI`](open_ai.md), [`Text Display`](text_display.md), [`Mask Area Measurement`](mask_area_measurement.md), [`Line Counter Visualization`](line_counter_visualization.md), [`Continue If`](continue_if.md), [`Google Gemini`](google_gemini.md), [`SAM 3`](sam3.md), [`Distance Measurement`](distance_measurement.md), [`OpenRouter`](open_router.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Dynamic Zone`](dynamic_zone.md), [`Mask Edge Snap`](mask_edge_snap.md), [`Anthropic Claude`](anthropic_claude.md), [`OpenAI`](open_ai.md)
