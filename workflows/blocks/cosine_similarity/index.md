...
??? tip "Compatible Blocks"
    ...
    - outputs: [`Stitch OCR Detections`](stitch_ocr_detections.md), [`Anthropic Claude`](anthropic_claude.md), [`SAM 3 Interactive`](sam3_interactive.md), [`Template Matching`](template_matching.md), [`Distance Measurement`](distance_measurement.md), [`Crop Visualization`](crop_visualization.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`OpenAI`](open_ai.md), [`Google Gemini`](google_gemini.md), [`PTZ Tracking (ONVIF)`](ptz_tracking(onvif).md), [`Keypoint Visualization`](keypoint_visualization.md), [`Anthropic Claude`](anthropic_claude.md), [`Webhook Sink`](webhook_sink.md), [`Mask Edge Snap`](mask_edge_snap.md), [`Mask Area Measurement`](mask_area_measurement.md), [`MQTT Writer`](mqtt_writer.md), [`Line Counter Visualization`](line_counter_visualization.md), [`OPC UA Writer Sink`](opcua_writer_sink.md), [`Label Visualization`](label_visualization.md), [`SAM 3`](sam3.md), [`Seg Preview`](seg_preview.md), [`Text Display`](text_display.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Qwen-VL`](qwen_vl.md), [`Continue If`](continue_if.md), [`Velocity`](velocity.md), [`Google Gemini`](google_gemini.md), [`Roboflow Dataset Upload`](roboflow_dataset_upload.md), [`Qwen 3.5 API`](qwen3.5_api.md), [`Camera Calibration`](camera_calibration.md), [`Qwen 3.6 API`](qwen3.6_api.md), [`Segment Anything 2 Model`](segment_anything2_model.md), [`SAM 3`](sam3.md), [`Dynamic Zone`](dynamic_zone.md), [`SAM 3`](sam3.md), [`OpenAI`](open_ai.md), [`SAM2 Video Tracker`](sam2_video_tracker.md), [`OpenAI`](open_ai.md), [`Heatmap Visualization`](heatmap_visualization.md), [`OpenAI-Compatible LLM`](open_ai_compatible_llm.md), [`Google Gemma API`](google_gemma_api.md), [`Detections List Roll-Up`](detections_list_roll_up.md), [`OpenRouter`](open_router.md), [`Detection Event Log`](detection_event_log.md), [`Google Gemini`](google_gemini.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`Anthropic Claude`](anthropic_claude.md), [`SAM3 Video Tracker`](sam3_video_tracker.md), [`Google Gemma`](google_gemma.md), [`Llama 3.2 Vision`](llama3.2_vision.md)
