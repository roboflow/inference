...
??? tip "Compatible Blocks"
    ...
    - outputs: [`Text Display`](text_display.md), [`Crop Visualization`](crop_visualization.md), [`SAM 3`](sam3.md), [`Detection Event Log`](detection_event_log.md), [`Roboflow Dataset Upload`](roboflow_dataset_upload.md), [`SAM2 Video Tracker`](sam2_video_tracker.md), [`Google Gemini`](google_gemini.md), [`Camera Calibration`](camera_calibration.md), [`Mask Edge Snap`](mask_edge_snap.md), [`Dynamic Zone`](dynamic_zone.md), [`OpenAI`](open_ai.md), [`SAM 3 Interactive`](sam3_interactive.md), [`Velocity`](velocity.md), [`MQTT Writer`](mqtt_writer.md), [`Continue If`](continue_if.md), [`Qwen-VL`](qwen_vl.md), [`Google Gemini`](google_gemini.md), [`Template Matching`](template_matching.md), [`SAM3 Video Tracker`](sam3_video_tracker.md), [`Stitch OCR Detections`](stitch_ocr_detections.md), [`Detections List Roll-Up`](detections_list_roll_up.md), [`Mask Area Measurement`](mask_area_measurement.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Qwen 3.6 API`](qwen3.6_api.md), [`Line Counter Visualization`](line_counter_visualization.md), [`Auto Rotate on Edges`](auto_rotateon_edges.md), [`Google Gemini`](google_gemini.md), [`OpenAI`](open_ai.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`SAM 3`](sam3.md), [`Heatmap Visualization`](heatmap_visualization.md), [`Roboflow Vision Events`](roboflow_vision_events.md), [`Segment Anything 2 Model`](segment_anything2_model.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Seg Preview`](seg_preview.md), [`Google Gemma`](google_gemma.md), [`Google Gemma API`](google_gemma_api.md), [`OpenAI-Compatible LLM`](open_ai_compatible_llm.md), [`Keypoint Visualization`](keypoint_visualization.md), [`Anthropic Claude`](anthropic_claude.md), [`Label Visualization`](label_visualization.md), [`Anthropic Claude`](anthropic_claude.md), [`OpenAI`](open_ai.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`Webhook Sink`](webhook_sink.md), [`Distance Measurement`](distance_measurement.md), [`SAM 3`](sam3.md), [`GeoTag Detection`](geo_tag_detection.md), [`PTZ Tracking (ONVIF)`](ptz_tracking(onvif).md), [`Qwen 3.5 API`](qwen3.5_api.md), [`OPC UA Writer Sink`](opcua_writer_sink.md), [`OpenRouter`](open_router.md), [`Anthropic Claude`](anthropic_claude.md)
