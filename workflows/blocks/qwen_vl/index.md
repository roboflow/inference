...
???+ tip "Bindings"
    ...
    - input
        ...
        - `api_key` (*Union[[`string`](../kinds/string.md), [`secret`](../kinds/secret.md), [`ROBOFLOW_MANAGED_KEY`](../kinds/roboflow_managed_key.md)]*): OpenRouter API key (only used when backend=openrouter). Defaults to Roboflow's managed key. Provide your own `sk-or-...` key to call OpenRouter directly without Roboflow billing..
