...
??? tip "Compatible Blocks"
    ...
    - inputs: [`Detections Filter`](detections_filter.md), [`Path Deviation`](path_deviation.md), [`Instance Segmentation Model`](instance_segmentation_model.md), [`SAM 3`](sam3.md), [`Detections Consensus`](detections_consensus.md), [`SAM 3 Interactive`](sam3_interactive.md), [`PTZ Tracking (ONVIF)`](ptz_tracking(onvif).md), [`Motion Detection`](motion_detection.md), [`Gaze Detection`](gaze_detection.md), [`Detection Offset`](detection_offset.md), [`Byte Tracker`](byte_tracker.md), [`SAM 3`](sam3.md), [`Dynamic Zone`](dynamic_zone.md), [`EasyOCR`](easy_ocr.md), [`Google Vision OCR`](google_vision_ocr.md), [`Detection Event Log`](detection_event_log.md), [`Camera Focus`](camera_focus.md), [`Track Class Lock`](track_class_lock.md), [`OC-SORT Tracker`](ocsort_tracker.md), [`YOLO-World Model`](yolo_world_model.md), [`Overlap Filter`](overlap_filter.md), [`Camera Focus`](camera_focus.md), [`Time in Zone`](timein_zone.md), [`Detections Stabilizer`](detections_stabilizer.md), [`SAM3 Video Tracker`](sam3_video_tracker.md), [`Moondream2`](moondream2.md), [`Dynamic Crop`](dynamic_crop.md), [`Detections Combine`](detections_combine.md), [`Object Detection Model`](object_detection_model.md), [`VLM As Detector`](vlm_as_detector.md), [`Identify Changes`](identify_changes.md), [`Perspective Correction`](perspective_correction.md), [`Detections Merge`](detections_merge.md), [`Segment Anything 2 Model`](segment_anything2_model.md), [`Mask Area Measurement`](mask_area_measurement.md), [`Instance Segmentation Model`](instance_segmentation_model.md), [`VLM As Detector`](vlm_as_detector.md), [`BoT-SORT Tracker`](bo_tsort_tracker.md), [`OCR Model`](ocr_model.md), [`Roboflow Visual Search Classifier`](roboflow_visual_search_classifier.md), [`SAM2 Video Tracker`](sam2_video_tracker.md), [`Detections Classes Replacement`](detections_classes_replacement.md), [`Instance Segmentation Model`](instance_segmentation_model.md), [`Line Counter`](line_counter.md), [`Byte Tracker`](byte_tracker.md), [`SAM 3`](sam3.md), [`Per-Class Confidence Filter`](per_class_confidence_filter.md), [`Detections Stitch`](detections_stitch.md), [`Mask Edge Snap`](mask_edge_snap.md), [`Time in Zone`](timein_zone.md), [`Byte Tracker`](byte_tracker.md), [`Detections Transformation`](detections_transformation.md), [`SORT Tracker`](sort_tracker.md), [`Time in Zone`](timein_zone.md), [`ByteTrack Tracker`](byte_track_tracker.md), [`Bounding Rectangle`](bounding_rectangle.md), [`Template Matching`](template_matching.md), [`Seg Preview`](seg_preview.md), [`Path Deviation`](path_deviation.md), [`Object Detection Model`](object_detection_model.md), [`Instance Segmentation Model`](instance_segmentation_model.md), [`Cosine Similarity`](cosine_similarity.md), [`Object Detection Model`](object_detection_model.md), [`Detections List Roll-Up`](detections_list_roll_up.md), [`Velocity`](velocity.md)
