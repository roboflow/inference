...
??? tip "Compatible Blocks"
    ...
    - inputs: [`Qwen-VL`](qwen_vl.md), [`Anthropic Claude`](anthropic_claude.md), [`Distance Measurement`](distance_measurement.md), [`Clip Comparison`](clip_comparison.md), [`Anthropic Claude`](anthropic_claude.md), [`Camera Focus`](camera_focus.md), [`OpenAI`](open_ai.md), [`Google Gemma`](google_gemma.md), [`Line Counter`](line_counter.md), [`SIFT Comparison`](sift_comparison.md), [`SIFT Comparison`](sift_comparison.md), [`Image Stack`](image_stack.md), [`Google Gemini`](google_gemini.md), [`Anthropic Claude`](anthropic_claude.md), [`Florence-2 Model`](florence2_model.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`Google Gemini`](google_gemini.md), [`Image Contours`](image_contours.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Qwen 3.6 API`](qwen3.6_api.md), [`OpenRouter`](open_router.md), [`Motion Detection`](motion_detection.md), [`Line Counter`](line_counter.md), [`Google Gemma API`](google_gemma_api.md), [`Qwen 3.5 API`](qwen3.5_api.md), [`Perspective Correction`](perspective_correction.md), [`Detection Event Log`](detection_event_log.md), [`Dimension Collapse`](dimension_collapse.md), [`Size Measurement`](size_measurement.md), [`Dynamic Zone`](dynamic_zone.md), [`Buffer`](buffer.md), [`Detections List Roll-Up`](detections_list_roll_up.md), [`Florence-2 Model`](florence2_model.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`OpenAI`](open_ai.md), [`Clip Comparison`](clip_comparison.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Template Matching`](template_matching.md), [`Pixel Color Count`](pixel_color_count.md), [`Google Gemini`](google_gemini.md), [`OpenAI`](open_ai.md)
