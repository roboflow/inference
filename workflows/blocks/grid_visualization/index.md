...
??? tip "Compatible Blocks"
    ...
    - inputs: [`Detection Event Log`](detection_event_log.md), [`Anthropic Claude`](anthropic_claude.md), [`Florence-2 Model`](florence2_model.md), [`Clip Comparison`](clip_comparison.md), [`OpenAI`](open_ai.md), [`Buffer`](buffer.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Pixel Color Count`](pixel_color_count.md), [`Perspective Correction`](perspective_correction.md), [`Template Matching`](template_matching.md), [`Qwen 3.5 API`](qwen3.5_api.md), [`Anthropic Claude`](anthropic_claude.md), [`Motion Detection`](motion_detection.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`Google Gemini`](google_gemini.md), [`Google Gemma`](google_gemma.md), [`Qwen-VL`](qwen_vl.md), [`Google Gemma API`](google_gemma_api.md), [`PLC ModbusTCP`](plc_modbus_tcp.md), [`Line Counter`](line_counter.md), [`PLC EthernetIP`](plc_ethernet_ip.md), [`Detections List Roll-Up`](detections_list_roll_up.md), [`OpenRouter`](open_router.md), [`Florence-2 Model`](florence2_model.md), [`Dimension Collapse`](dimension_collapse.md), [`Distance Measurement`](distance_measurement.md), [`Image Stack`](image_stack.md), [`Google Gemini`](google_gemini.md), [`Camera Focus`](camera_focus.md), [`OpenAI`](open_ai.md), [`Qwen 3.6 API`](qwen3.6_api.md), [`Image Contours`](image_contours.md), [`SIFT Comparison`](sift_comparison.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Size Measurement`](size_measurement.md), [`SIFT Comparison`](sift_comparison.md), [`Google Gemini`](google_gemini.md), [`Clip Comparison`](clip_comparison.md), [`OpenAI`](open_ai.md), [`Anthropic Claude`](anthropic_claude.md), [`Line Counter`](line_counter.md), [`Dynamic Zone`](dynamic_zone.md)
