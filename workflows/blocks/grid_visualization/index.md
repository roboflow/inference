...
??? tip "Compatible Blocks"
    ...
    - inputs: [`Roboflow Visual Search`](roboflow_visual_search.md), [`Google Gemma API`](google_gemma_api.md), [`Qwen-VL`](qwen_vl.md), [`SIFT Comparison`](sift_comparison.md), [`Dimension Collapse`](dimension_collapse.md), [`Image Stack`](image_stack.md), [`Motion Detection`](motion_detection.md), [`Anthropic Claude`](anthropic_claude.md), [`Dynamic Zone`](dynamic_zone.md), [`Clip Comparison`](clip_comparison.md), [`Detection Event Log`](detection_event_log.md), [`Image Contours`](image_contours.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Camera Focus`](camera_focus.md), [`Anthropic Claude`](anthropic_claude.md), [`Florence-2 Model`](florence2_model.md), [`OpenAI`](open_ai.md), [`OpenRouter`](open_router.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`Qwen 3.6 API`](qwen3.6_api.md), [`Google Gemma`](google_gemma.md), [`OpenAI`](open_ai.md), [`Perspective Correction`](perspective_correction.md), [`Google Gemini`](google_gemini.md), [`Line Counter`](line_counter.md), [`Google Gemini`](google_gemini.md), [`Clip Comparison`](clip_comparison.md), [`Roboflow Visual Search Classifier`](roboflow_visual_search_classifier.md), [`PLC ModbusTCP`](plc_modbus_tcp.md), [`Line Counter`](line_counter.md), [`PLC EthernetIP`](plc_ethernet_ip.md), [`Distance Measurement`](distance_measurement.md), [`Size Measurement`](size_measurement.md), [`Florence-2 Model`](florence2_model.md), [`OpenAI`](open_ai.md), [`Buffer`](buffer.md), [`Google Gemini`](google_gemini.md), [`GeoTag Detection`](geo_tag_detection.md), [`Template Matching`](template_matching.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`SIFT Comparison`](sift_comparison.md), [`Anthropic Claude`](anthropic_claude.md), [`Pixel Color Count`](pixel_color_count.md), [`Qwen 3.5 API`](qwen3.5_api.md), [`Detections List Roll-Up`](detections_list_roll_up.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md)
