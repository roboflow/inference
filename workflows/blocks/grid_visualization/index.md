...
??? tip "Compatible Blocks"
    ...
    - inputs: [`Image Stack`](image_stack.md), [`Anthropic Claude`](anthropic_claude.md), [`Template Matching`](template_matching.md), [`Distance Measurement`](distance_measurement.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`OpenAI`](open_ai.md), [`Google Gemini`](google_gemini.md), [`Anthropic Claude`](anthropic_claude.md), [`Size Measurement`](size_measurement.md), [`Florence-2 Model`](florence2_model.md), [`Image Contours`](image_contours.md), [`Perspective Correction`](perspective_correction.md), [`Florence-2 Model`](florence2_model.md), [`Qwen-VL`](qwen_vl.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`PLC ModbusTCP`](plc_modbus_tcp.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`Pixel Color Count`](pixel_color_count.md), [`Motion Detection`](motion_detection.md), [`Clip Comparison`](clip_comparison.md), [`Google Gemini`](google_gemini.md), [`Dimension Collapse`](dimension_collapse.md), [`Qwen 3.5 API`](qwen3.5_api.md), [`Qwen 3.6 API`](qwen3.6_api.md), [`Google Gemma`](google_gemma.md), [`Camera Focus`](camera_focus.md), [`OpenAI`](open_ai.md), [`Line Counter`](line_counter.md), [`OpenAI`](open_ai.md), [`SIFT Comparison`](sift_comparison.md), [`Clip Comparison`](clip_comparison.md), [`Google Gemma API`](google_gemma_api.md), [`Detections List Roll-Up`](detections_list_roll_up.md), [`Google Gemini`](google_gemini.md), [`OpenRouter`](open_router.md), [`PLC EthernetIP`](plc_ethernet_ip.md), [`Detection Event Log`](detection_event_log.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`SIFT Comparison`](sift_comparison.md), [`Anthropic Claude`](anthropic_claude.md), [`Line Counter`](line_counter.md), [`Dynamic Zone`](dynamic_zone.md), [`Buffer`](buffer.md)
