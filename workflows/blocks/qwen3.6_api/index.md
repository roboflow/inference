...
??? "Class: `Qwen36OpenRouterBlockV1`"

    Source:
    <a target="_blank" href="https://github.com/roboflow/inference/blob/main/inference/core/workflows/core_steps/models/foundation/qwen3_6_openrouter/v1.py">inference.core.workflows.core_steps.models.foundation.qwen3_6_openrouter.v1.Qwen36OpenRouterBlockV1</a>
    



Ask a question to Qwen 3.6 vision-language models served via OpenRouter.
...
Qwen 3.6 is exposed via [OpenRouter API](https://openrouter.ai/) and we require
passing an [OpenRouter API Key](https://openrouter.ai/docs/api-keys) to run.

Pick a specific model version from the `model_version` dropdown - new Qwen 3.6 releases
...
Use the following identifier in step `"type"` field: `roboflow_core/qwen3_6_openrouter@v1`to add the block as
...
| `prompt` | `str` | Text prompt to the Qwen 3.6 model. | ✅ |
...
??? tip "Compatible Blocks"
    Check what blocks you can connect to `Qwen 3.6 API` in version `v1`.
...
`Qwen 3.6 API` in version `v1`  has.
...
???+ tip "Bindings"
    ...
    - input
        ...
        - `prompt` (*[`string`](../kinds/string.md)*): Text prompt to the Qwen 3.6 model.
...
??? tip "Example JSON definition of step `Qwen 3.6 API` in version `v1`"
