...
???+ tip "Bindings"
    ...
    - input
        ...
        - `query_parameters` (*Union[[`roboflow_project`](../kinds/roboflow_project.md), [`roboflow_api_key`](../kinds/roboflow_api_key.md), [`integer`](../kinds/integer.md), [`float_zero_to_one`](../kinds/float_zero_to_one.md), [`top_class`](../kinds/top_class.md), [`boolean`](../kinds/boolean.md), [`roboflow_model_id`](../kinds/roboflow_model_id.md), [`string`](../kinds/string.md), [`list_of_values`](../kinds/list_of_values.md), [`float`](../kinds/float.md)]*): Request query parameters.
        - `headers` (*Union[[`roboflow_project`](../kinds/roboflow_project.md), [`roboflow_api_key`](../kinds/roboflow_api_key.md), [`integer`](../kinds/integer.md), [`float_zero_to_one`](../kinds/float_zero_to_one.md), [`top_class`](../kinds/top_class.md), [`boolean`](../kinds/boolean.md), [`roboflow_model_id`](../kinds/roboflow_model_id.md), [`string`](../kinds/string.md), [`float`](../kinds/float.md)]*): Request headers.
