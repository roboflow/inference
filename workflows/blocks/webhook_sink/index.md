...
???+ tip "Bindings"
    ...
    - input
        ...
        - `query_parameters` (*Union[[`roboflow_model_id`](../kinds/roboflow_model_id.md), [`integer`](../kinds/integer.md), [`top_class`](../kinds/top_class.md), [`float`](../kinds/float.md), [`list_of_values`](../kinds/list_of_values.md), [`boolean`](../kinds/boolean.md), [`roboflow_api_key`](../kinds/roboflow_api_key.md), [`roboflow_project`](../kinds/roboflow_project.md), [`float_zero_to_one`](../kinds/float_zero_to_one.md), [`string`](../kinds/string.md)]*): Request query parameters.
        - `headers` (*Union[[`roboflow_model_id`](../kinds/roboflow_model_id.md), [`integer`](../kinds/integer.md), [`top_class`](../kinds/top_class.md), [`float`](../kinds/float.md), [`boolean`](../kinds/boolean.md), [`roboflow_api_key`](../kinds/roboflow_api_key.md), [`roboflow_project`](../kinds/roboflow_project.md), [`float_zero_to_one`](../kinds/float_zero_to_one.md), [`string`](../kinds/string.md)]*): Request headers.
