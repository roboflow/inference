...
???+ tip "Bindings"
    ...
    - input
        ...
        - `query_parameters` (*Union[[`float_zero_to_one`](../kinds/float_zero_to_one.md), [`integer`](../kinds/integer.md), [`float`](../kinds/float.md), [`list_of_values`](../kinds/list_of_values.md), [`string`](../kinds/string.md), [`roboflow_api_key`](../kinds/roboflow_api_key.md), [`roboflow_model_id`](../kinds/roboflow_model_id.md), [`roboflow_project`](../kinds/roboflow_project.md), [`top_class`](../kinds/top_class.md), [`boolean`](../kinds/boolean.md)]*): Request query parameters.
        - `headers` (*Union[[`float_zero_to_one`](../kinds/float_zero_to_one.md), [`integer`](../kinds/integer.md), [`float`](../kinds/float.md), [`string`](../kinds/string.md), [`roboflow_api_key`](../kinds/roboflow_api_key.md), [`roboflow_model_id`](../kinds/roboflow_model_id.md), [`roboflow_project`](../kinds/roboflow_project.md), [`top_class`](../kinds/top_class.md), [`boolean`](../kinds/boolean.md)]*): Request headers.
