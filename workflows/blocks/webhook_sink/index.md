...
???+ tip "Bindings"
    ...
    - input
        ...
        - `query_parameters` (*Union[[`list_of_values`](../kinds/list_of_values.md), [`top_class`](../kinds/top_class.md), [`roboflow_model_id`](../kinds/roboflow_model_id.md), [`roboflow_api_key`](../kinds/roboflow_api_key.md), [`boolean`](../kinds/boolean.md), [`integer`](../kinds/integer.md), [`roboflow_project`](../kinds/roboflow_project.md), [`float_zero_to_one`](../kinds/float_zero_to_one.md), [`float`](../kinds/float.md), [`string`](../kinds/string.md)]*): Request query parameters.
        - `headers` (*Union[[`top_class`](../kinds/top_class.md), [`roboflow_model_id`](../kinds/roboflow_model_id.md), [`roboflow_api_key`](../kinds/roboflow_api_key.md), [`boolean`](../kinds/boolean.md), [`integer`](../kinds/integer.md), [`roboflow_project`](../kinds/roboflow_project.md), [`float_zero_to_one`](../kinds/float_zero_to_one.md), [`float`](../kinds/float.md), [`string`](../kinds/string.md)]*): Request headers.
