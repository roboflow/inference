...
???+ tip "Bindings"
    ...
    - input
        ...
        - `query_parameters` (*Union[[`float`](../kinds/float.md), [`integer`](../kinds/integer.md), [`float_zero_to_one`](../kinds/float_zero_to_one.md), [`list_of_values`](../kinds/list_of_values.md), [`roboflow_model_id`](../kinds/roboflow_model_id.md), [`roboflow_api_key`](../kinds/roboflow_api_key.md), [`string`](../kinds/string.md), [`boolean`](../kinds/boolean.md), [`roboflow_project`](../kinds/roboflow_project.md), [`top_class`](../kinds/top_class.md)]*): Request query parameters.
        - `headers` (*Union[[`float`](../kinds/float.md), [`integer`](../kinds/integer.md), [`float_zero_to_one`](../kinds/float_zero_to_one.md), [`roboflow_model_id`](../kinds/roboflow_model_id.md), [`roboflow_api_key`](../kinds/roboflow_api_key.md), [`string`](../kinds/string.md), [`boolean`](../kinds/boolean.md), [`roboflow_project`](../kinds/roboflow_project.md), [`top_class`](../kinds/top_class.md)]*): Request headers.
