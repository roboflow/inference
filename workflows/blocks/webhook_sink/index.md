...
???+ tip "Bindings"
    ...
    - input
        ...
        - `query_parameters` (*Union[[`top_class`](../kinds/top_class.md), [`roboflow_model_id`](../kinds/roboflow_model_id.md), [`boolean`](../kinds/boolean.md), [`integer`](../kinds/integer.md), [`float_zero_to_one`](../kinds/float_zero_to_one.md), [`roboflow_api_key`](../kinds/roboflow_api_key.md), [`roboflow_project`](../kinds/roboflow_project.md), [`list_of_values`](../kinds/list_of_values.md), [`string`](../kinds/string.md), [`float`](../kinds/float.md)]*): Request query parameters.
        - `headers` (*Union[[`top_class`](../kinds/top_class.md), [`roboflow_model_id`](../kinds/roboflow_model_id.md), [`boolean`](../kinds/boolean.md), [`integer`](../kinds/integer.md), [`roboflow_api_key`](../kinds/roboflow_api_key.md), [`roboflow_project`](../kinds/roboflow_project.md), [`float_zero_to_one`](../kinds/float_zero_to_one.md), [`string`](../kinds/string.md), [`float`](../kinds/float.md)]*): Request headers.
