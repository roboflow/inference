...
???+ tip "Bindings"
    ...
    - input
        ...
        - `query_parameters` (*Union[[`roboflow_project`](../kinds/roboflow_project.md), [`float`](../kinds/float.md), [`top_class`](../kinds/top_class.md), [`boolean`](../kinds/boolean.md), [`float_zero_to_one`](../kinds/float_zero_to_one.md), [`string`](../kinds/string.md), [`list_of_values`](../kinds/list_of_values.md), [`integer`](../kinds/integer.md), [`roboflow_api_key`](../kinds/roboflow_api_key.md), [`roboflow_model_id`](../kinds/roboflow_model_id.md)]*): Request query parameters.
        - `headers` (*Union[[`roboflow_project`](../kinds/roboflow_project.md), [`float`](../kinds/float.md), [`top_class`](../kinds/top_class.md), [`boolean`](../kinds/boolean.md), [`float_zero_to_one`](../kinds/float_zero_to_one.md), [`string`](../kinds/string.md), [`integer`](../kinds/integer.md), [`roboflow_api_key`](../kinds/roboflow_api_key.md), [`roboflow_model_id`](../kinds/roboflow_model_id.md)]*): Request headers.
