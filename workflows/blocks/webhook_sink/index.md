...
???+ tip "Bindings"
    ...
    - input
        ...
        - `query_parameters` (*Union[[`roboflow_project`](../kinds/roboflow_project.md), [`top_class`](../kinds/top_class.md), [`float`](../kinds/float.md), [`integer`](../kinds/integer.md), [`roboflow_model_id`](../kinds/roboflow_model_id.md), [`list_of_values`](../kinds/list_of_values.md), [`boolean`](../kinds/boolean.md), [`roboflow_api_key`](../kinds/roboflow_api_key.md), [`string`](../kinds/string.md), [`float_zero_to_one`](../kinds/float_zero_to_one.md)]*): Request query parameters.
        - `headers` (*Union[[`roboflow_project`](../kinds/roboflow_project.md), [`top_class`](../kinds/top_class.md), [`float`](../kinds/float.md), [`integer`](../kinds/integer.md), [`roboflow_model_id`](../kinds/roboflow_model_id.md), [`boolean`](../kinds/boolean.md), [`roboflow_api_key`](../kinds/roboflow_api_key.md), [`string`](../kinds/string.md), [`float_zero_to_one`](../kinds/float_zero_to_one.md)]*): Request headers.
