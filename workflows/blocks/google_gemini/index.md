...
???+ tip "Bindings"
    ...
    - input
        ...
        - `api_key` (*Union[[`secret`](../kinds/secret.md), [`ROBOFLOW_MANAGED_KEY`](../kinds/roboflow_managed_key.md), [`string`](../kinds/string.md)]*): Your Google AI API key or 'rf_key:account' to use Roboflow's managed API key.
