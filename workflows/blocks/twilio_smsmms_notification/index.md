...
???+ tip "Bindings"
    ...
    - input
        ...
        - `media_url` (*Union[[`string`](../kinds/string.md), [`image`](../kinds/image.md), [`list_of_values`](../kinds/list_of_values.md)]*): Optional media URL(s) for MMS. Provide publicly accessible image URLs or image outputs from workflow blocks..
