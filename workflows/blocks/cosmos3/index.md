...
??? "Class: `Cosmos3EdgeBlockV1`"
    ...
    Source:
    <a target="_blank" href="https://github.com/roboflow/inference/blob/main/inference/core/workflows/core_steps/models/foundation/cosmos3/v1.py">inference.core.workflows.core_steps.models.foundation.cosmos3.v1.Cosmos3EdgeBlockV1</a>
...
Use the following identifier in step `"type"` field: `roboflow_core/cosmos3_edge@v1`to add the block as
...
???+ tip "Bindings"
    ...
    - input
        ...
        - `prompt` (*[`string`](../kinds/string.md)*): Optional text prompt to pass to Cosmos 3 Edge. Otherwise a default scene-description prompt is used, which may affect the desired model behavior..
        - `model_version` (*[`roboflow_model_id`](../kinds/roboflow_model_id.md)*): The Cosmos 3 Edge model to be used for inference..
        - `system_prompt` (*[`string`](../kinds/string.md)*): Optional system prompt to provide additional context to Cosmos 3 Edge..
...
??? tip "Example JSON definition of step `Cosmos 3` in version `v1`"
