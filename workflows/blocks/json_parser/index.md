...
??? tip "Compatible Blocks"
    ...
    - inputs: [`Cosmos 3`](cosmos3.md), [`Google Gemini`](google_gemini.md), [`Florence-2 Model`](florence2_model.md), [`Google Gemini`](google_gemini.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`OpenRouter`](open_router.md), [`Qwen 3.5 API`](qwen3.5_api.md), [`MoonshotAI Kimi`](moonshot_ai_kimi.md), [`Anthropic Claude`](anthropic_claude.md), [`OpenAI`](open_ai.md), [`Anthropic Claude`](anthropic_claude.md), [`Google Gemini`](google_gemini.md), [`OpenAI`](open_ai.md), [`Anthropic Claude`](anthropic_claude.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Llama 3.2 Vision`](llama3.2_vision.md), [`Qwen 3.6 API`](qwen3.6_api.md), [`Florence-2 Model`](florence2_model.md), [`Google Gemini`](google_gemini.md), [`Google Gemma API`](google_gemma_api.md), [`OpenAI`](open_ai.md), [`Google Gemma`](google_gemma.md), [`OpenAI-Compatible LLM`](open_ai_compatible_llm.md), [`Qwen-VL`](qwen_vl.md), [`GLM-OCR`](glmocr.md)
