...
Refer to our [Supported Blocks](/workflows/blocks.md) documentation to learn more about what blocks are supported.
We also recommend reading the [Understanding workflows](/workflows/understanding.md) page.
