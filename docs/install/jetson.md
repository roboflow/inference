...
**JetPack Version**: Must be running a supported JetPack (7.2, 6.2, or 5.1.x). We recommend JetPack 7.2, which supports both Orin and Thor. JetPack 5.1.x is deprecated, and JetPack 6.2 support will also end in 2027 — plan to migrate to JetPack 7.2.
...
=== "Jetpack 6.2"
    !!! info
        JetPack 6.2 support will end in 2027. Consider JetPack 7.2 for new deployments.
...
=== "Jetpack 5"
    !!! Warning
        JetPack 5 (5.1.x) is deprecated. Support will be removed in 2027.
        Please migrate to JetPack 7.2.
...
=== "Jetpack 7.2"
    ...
    services:
      inference-server:
        container_name: inference-server
        image: roboflow/roboflow-inference-server-jetson-7.2.0:latest
