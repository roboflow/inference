"""
Test script for instance segmentation using inference-exp with ONNX backend.

This script mirrors test_seg.py but uses the experimental inference library (inference-exp)
with explicit ONNX backend for the segmentation model.
"""
...
# Load model using AutoModel with ONNX backend
print("Loading rfdetr-seg-preview model with ONNX backend...")
...
cv2.imwrite("rfdetr_seg_exp_onnx_result.png", annotated_image)
print("Saved visualization to rfdetr_seg_exp_onnx_result.png")
