...
from inference.core.registries.decorators.fixed_device_id import WithFixedDeviceId
...
model_registry = WithFixedDeviceId(
    RoboflowModelRegistry(ROBOFLOW_MODEL_TYPES), device_id="HostedInferenceLambda"
)
