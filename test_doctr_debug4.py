"""
Debug script - check all packages including features
"""
import os
...
print("Fetching model metadata for doctr/default...")
try:
    metadata = get_model_metadata(model_id="doctr/default", api_key="zaRavHwbvIXpGerDM3wi")
