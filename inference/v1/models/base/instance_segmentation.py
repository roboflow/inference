...
class InstanceSegmentationModel(ABC):
    ...
    @classmethod
    def from_pretrained(cls, model_name_or_path: str, *args, **kwargs) -> "InstanceSegmentationModel":
        pass
    ...
    def infer(self, images: torch.Tensor, *args, **kwargs) -> List[InstanceDetections]:
    ...
    @abstractmethod
    def post_process(self, model_results: torch.Tensor, *args, **kwargs) -> List[InstanceDetections]:
        pass

    def __call__(self, images: torch.Tensor, *args, **kwargs) -> List[InstanceDetections]:
