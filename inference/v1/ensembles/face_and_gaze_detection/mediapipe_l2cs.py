...
from inference.v1 import Detections, KeyPoints
...
from inference.v1.models.l2cs.l2cs_onnx import (
    DEFAULT_GAZE_MAX_BATCH_SIZE,
    GazeDetection,
    L2CSNetOnnx,
)
from inference.v1.models.mediapipe_face_detection.face_detection import (
