...
WEBRTC_MODAL_CPU_IMAGE_NAME = os.getenv(
    "WEBRTC_MODAL_CPU_IMAGE_NAME", "roboflow/roboflow-inference-server-cpu"
)
WEBRTC_MODAL_CPU_IMAGE_TAG = os.getenv("WEBRTC_MODAL_CPU_IMAGE_TAG")
