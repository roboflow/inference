...
ALLOW_CUSTOM_PYTHON_EXECUTION_IN_WORKFLOWS = str2bool(
    os.getenv("ALLOW_CUSTOM_PYTHON_EXECUTION_IN_WORKFLOWS", False)
)
ALLOW_HTTP_CUSTOM_PYTHON_EXECUTION_IN_WORKFLOWS = str2bool(
    os.getenv("ALLOW_HTTP_CUSTOM_PYTHON_EXECUTION_IN_WORKFLOWS", False)
)
