...
WORKFLOWS_INNER_WORKFLOW_DISPATCH_TARGET_URL = os.getenv(
    "WORKFLOWS_INNER_WORKFLOW_DISPATCH_TARGET_URL",
    "https://serverless.roboflow.com",
)
WORKFLOWS_INNER_WORKFLOW_DISPATCH_REQUEST_TIMEOUT = float(
    os.getenv("WORKFLOWS_INNER_WORKFLOW_DISPATCH_REQUEST_TIMEOUT", "300.0")
)
