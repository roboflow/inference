...
DEPLOYMENTS_STEP_EXECUTION_MODE = os.getenv("DEPLOYMENTS_STEP_EXECUTION_MODE", "remote")
DEPLOYMENTS_MAX_CONCURRENT_STEPS = int(os.getenv("DEPLOYMENTS_MAX_CONCURRENT_STEPS", "8"))
