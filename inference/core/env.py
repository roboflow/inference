...
WHITELISTED_DESTINATIONS_FOR_URL_INPUT = os.getenv("WHITELISTED_DOMAINS_FOR_URL_INPUT")
...
BLACKLISTED_DESTINATIONS_FOR_URL_INPUT = os.getenv("BLACKLISTED_DOMAINS_FOR_URL_INPUT")
