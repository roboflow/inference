...
WORKFLOWS_MAX_INNER_WORKFLOW_DEPTH = int(
    os.getenv(
        ...
        os.getenv("WORKFLOWS_MAX_SUBWORKFLOW_DEPTH", "8"),
    )
)
# Backward compatibility for imports and env: prefer WORKFLOWS_MAX_INNER_WORKFLOW_DEPTH.
WORKFLOWS_MAX_SUBWORKFLOW_DEPTH = WORKFLOWS_MAX_INNER_WORKFLOW_DEPTH
