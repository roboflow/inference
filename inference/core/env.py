...
ENABLE_INFERENCE_CORE_PROFILING = str2bool(
    os.getenv("ENABLE_INFERENCE_CORE_PROFILING", "False")
)
INFERENCE_CORE_PROFILER_BUFFER_SIZE = int(os.getenv("INFERENCE_CORE_PROFILER_BUFFER_SIZE", "16384"))
