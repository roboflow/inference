"""Per-pipeline stream session identity.
...
This module must stay import-light: the pipeline binds the variable and the
usage collector reads it (through ``inference.usage_tracking.stream_session``,
which re-exports these exact objects), so it may import neither.
"""
