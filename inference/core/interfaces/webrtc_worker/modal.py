...
if modal is not None:
    ...
    @app.function(
        ...
        env={
            ...
            "WEBRTC_MODAL_FUNCTION_SCALEDOWN_WINDOW": str(WEBRTC_MODAL_FUNCTION_SCALEDOWN_WINDOW),
            "WEBRTC_MODAL_FUNCTION_BUFFER_CONTAINERS": str(WEBRTC_MODAL_FUNCTION_BUFFER_CONTAINERS),
            "WEBRTC_MODAL_FUNCTION_MIN_CONTAINERS": str(WEBRTC_MODAL_FUNCTION_MIN_CONTAINERS),
