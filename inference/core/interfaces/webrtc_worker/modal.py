...
if modal is not None:
    ...
    for instance_type in ["cpu", "gpu"]:
        ...
        _MODAL_FUNCTIONS_CACHE[instance_type] = rtc_peer_connection_modal
    ...
    def spawn_rtc_peer_connection_modal(
        ...
        func = _MODAL_FUNCTIONS_CACHE[webrtc_request.instance_type]
        deployed_func = modal.Function.from_name(
            app_name=app.name, name=func.info.function_name
        )
