...
if __name__ == '__main__':
    ...
    parser.add_argument("--stream_uri", help="URI of video stream", type=str, required=True)
    parser.add_argument("--max_fps", help="Limit FPS", type=int, required=False, default=None)
