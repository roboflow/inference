...
class ClipEmbeddingResponse(InferenceResponse):
    ...
    time: Optional[float] = Field(
        None, description="The time in seconds it took to produce the embeddings including preprocessing"
    )
...
class ClipCompareResponse(InferenceResponse):
    ...
    time: Optional[float] = Field(
        None, description="The time in seconds it took to produce the similarity scores including preprocessing"
    )
