...
class CropManifest(ColorableVisualizationManifest):
    ...
    scale_factor: Union[float, ScalarSelector(kind=[FLOAT_KIND])] = Field(  # type: ignore
    ...
    border_thickness: Union[int, ScalarSelector(kind=[INTEGER_KIND])] = Field(  # type: ignore
