...
class LineCounterZoneVisualizationManifest(VisualizationManifest):
    ...
    count_in: Union[int, WorkflowParameterSelector(kind=[INTEGER_KIND]), BatchSelector(kind=[INTEGER_KIND])] = Field(  # type: ignore
    ...
    count_out: Union[int, WorkflowParameterSelector(kind=[INTEGER_KIND]), BatchSelector(kind=[INTEGER_KIND])] = Field(  # type: ignore
