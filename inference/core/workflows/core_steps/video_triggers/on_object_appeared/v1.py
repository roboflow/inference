...
class BlockManifest(WorkflowBlockManifest):
    ...
    type: Literal["roboflow_core/on_object_appeared@v1"]
...
class OnObjectAppearedBlockV1(WorkflowBlock):
    ...
    def run(
        ...
        print(filtered_prediction.tracker_id.tolist())
        return {
