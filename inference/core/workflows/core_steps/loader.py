...
def load_blocks() -> List[Type[WorkflowBlock]]:
    ...
    if _blocks_cache is None:
        _blocks_cache = list(_load_blocks_once())
...
# Imports moved inside for lazy loading on first function call
def _load_blocks_once() -> List[Type[WorkflowBlock]]:
    ...
    # Tuple instead of list, constant build
    return (
        AbsoluteStaticCropBlockV1,
        DynamicCropBlockV1,
        DetectionsFilterBlockV1,
