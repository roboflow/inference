...
from inference.core.workflows.core_steps.sinks.obs.client import (
    call_with_reconnect,
    register_connection,
)
    ...
    def get_restrictions(cls) -> List[RuntimeRestriction]:
        return [
            ...
            RuntimeRestriction(
                severity=Severity.HARD,
                note=(
                    "Block requires step_execution_mode=local. OBS requests must be "
                    "issued from the process that drives the workflow, since a remote "
                    "inference server cannot reach a local OBS websocket."
                ),
