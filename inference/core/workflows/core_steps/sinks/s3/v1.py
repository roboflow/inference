...
1. **Explicit fields** — provide `aws_access_key_id` and `aws_secret_access_key` (optionally `aws_region`) directly in the block, or connect them to a secrets provider block such as `Environment Secrets Store`
