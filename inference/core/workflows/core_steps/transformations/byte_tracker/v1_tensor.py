...
3. Wraps tensor-native predictions in SuperiorVision Detections without moving them off-device, runs ByteTrack, and gathers the surviving rows as native tensors. Tracker IDs remain device tensors and are mirrored into `bboxes_metadata` for legacy consumers.
