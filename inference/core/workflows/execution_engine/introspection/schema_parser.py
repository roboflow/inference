...
def retrieve_selectors_from_simple_property(
    ...
    # Inlined property_defines_union check
    if (
...
def retrieve_selectors_from_union_definition(
    ...
    results = []
    # Process union types more efficiently by iterating once
