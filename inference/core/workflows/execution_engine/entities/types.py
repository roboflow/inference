...
# DEPRECATED KINDS - do not use to create new blocks!
BATCH_OF_IMAGES_KIND = IMAGE_KIND
BATCH_OF_SERIALISED_PAYLOADS_KIND = SERIALISED_PAYLOADS_KIND
BATCH_OF_BOOLEAN_KIND = BOOLEAN_KIND
BATCH_OF_STRING_KIND = STRING_KIND
BATCH_OF_INTEGER_KIND = INTEGER_KIND
BATCH_OF_TOP_CLASS_KIND = TOP_CLASS_KIND
BATCH_OF_DICTIONARY_KIND = DICTIONARY_KIND
BATCH_OF_CLASSIFICATION_PREDICTION_KIND = CLASSIFICATION_PREDICTION_KIND
BATCH_OF_OBJECT_DETECTION_PREDICTION_KIND = OBJECT_DETECTION_PREDICTION_KIND
BATCH_OF_INSTANCE_SEGMENTATION_PREDICTION_KIND = INSTANCE_SEGMENTATION_PREDICTION_KIND
BATCH_OF_KEYPOINT_DETECTION_PREDICTION_KIND = KEYPOINT_DETECTION_PREDICTION_KIND
BATCH_OF_QR_CODE_DETECTION_KIND = QR_CODE_DETECTION_KIND
BATCH_OF_BAR_CODE_DETECTION_KIND = BAR_CODE_DETECTION_KIND
BATCH_OF_PREDICTION_TYPE_KIND = PREDICTION_TYPE_KIND
BATCH_OF_PARENT_ID_KIND = PARENT_ID_KIND
BATCH_OF_IMAGE_METADATA_KIND = IMAGE_METADATA_KIND
