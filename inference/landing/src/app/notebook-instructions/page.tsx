      ...
      >
        <div className="flex flex-col items-center gap-2 md:gap-10 pb-12 md:px-6 lg:px-10 w-full text-center ">
          <div className="flex  pt-12 flex-col gap-1 items-center relative z-10">
            ...
            argument <span className="font-mono whitespace-break-spaces text-xs break-normal lg:text-[13px] bg-black bg-opacity-90 font-normal py-1 px-2 border border-gray-900 mx-1 text-white rounded">-e NOTEBOOK_ENABLED=true</span>.</span> 
