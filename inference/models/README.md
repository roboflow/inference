...
| `inference/models/deep_lab_v3_plus`   |                                          [MIT](https://github.com/VainF/DeepLabV3Plus-Pytorch/blob/master/LICENSE)                                           |              👍              |
| `inference/models/glm_ocr`   |                                                 [MIT](https://huggingface.co/datasets/choosealicense/licenses/blob/main/markdown/mit.md)                                                  |              👍              |
## Commercial Licenses
