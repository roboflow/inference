...
# 0 disables each trigger. When either trigger is enabled, the worker checks
# reserved-allocated and calls torch.cuda.empty_cache() only if it exceeds
# INFERENCE_WORKER_EMPTY_CACHE_MIN_FREE_BYTES.
INFERENCE_WORKER_EMPTY_CACHE_EVERY_N_BATCHES = get_integer_from_env(
    "INFERENCE_WORKER_EMPTY_CACHE_EVERY_N_BATCHES", default=0
)
INFERENCE_WORKER_EMPTY_CACHE_CHECK_INTERVAL_S = get_float_from_env(
    "INFERENCE_WORKER_EMPTY_CACHE_CHECK_INTERVAL_S", default=0.0
)
