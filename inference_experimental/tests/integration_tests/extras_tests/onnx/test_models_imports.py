...
def test_import_of_onnx_utils() -> None:
    import inference_exp.models.common.onnx
...
def test_import_yolov5_object_detection_onnx() -> None:
    from inference_exp.models.yolov5.yolov5_object_detection_onnx import (
...
def test_import_yolov7_instance_segmentation_onnx() -> None:
    from inference_exp.models.yolov7.yolov7_instance_segmentation_onnx import (
...
def test_import_yolov9_object_detection_onnx() -> None:
    from inference_exp.models.yolov9.yolov9_onnx import YOLOv9ForObjectDetectionOnnx


@pytest.mark.onnx_extras
def test_import_yolov10_object_detection_onnx() -> None:
    from inference_exp.models.yolov10.yolov10_object_detection_onnx import (
...
def test_import_yolov11_object_detection_onnx() -> None:
    from inference_exp.models.yolov11.yolov11_onnx import YOLOv11ForObjectDetectionOnnx


@pytest.mark.onnx_extras
def test_import_yolov11_instance_segmentation_onnx() -> None:
    from inference_exp.models.yolov11.yolov11_onnx import (
...
def test_import_yolov12_object_detection_onnx() -> None:
    from inference_exp.models.yolov12.yolov12_onnx import YOLOv12ForObjectDetectionOnnx
