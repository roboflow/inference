...
def test_clip_torch_vs_baseline_for_image_embeddings(
    ...
    wrapper_embeddings = clip_torch_wrapper.embed_images(images=[image])
...
def test_embed_single_numpy_image(clip_torch_wrapper: ClipTorch):
    # given
    image = np.random.randint(0, 255, size=(224, 224, 3), dtype=np.uint8)
...
def test_embed_single_tensor_image(clip_torch_wrapper: ClipTorch):
    # given
...
def test_embed_list_of_numpy_images(clip_torch_wrapper: ClipTorch):
    # given
    images = [
...
def test_embed_list_of_tensor_images(clip_torch_wrapper: ClipTorch):
    # given
    images = [
...
def test_embed_batch_of_tensor_images(clip_torch_wrapper: ClipTorch):
    # given
