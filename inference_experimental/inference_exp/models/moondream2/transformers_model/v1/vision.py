...
def vision_projection(
    ...
    # cast to cpu
    reconstructed = reconstructed.to(torch.cuda() if torch.cuda.is_available() else "cpu")
    global_features = global_features.to(torch.cuda() if torch.cuda.is_available() else "cpu")
