...
class TRTPackageDetails:
    ...
    def __str__(self):
        return f"TRTPackageDetails(dynamic_batch=({self.min_dynamic_batch_size}/{self.opt_dynamic_batch_size}/{self.max_dynamic_batch_size}), same_cc_compatible={self.same_cc_compatible})"
