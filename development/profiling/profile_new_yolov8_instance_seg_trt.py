...
from inference.v1.models.yolov8.yolov8_instance_segmentation_trt import YOLOv8ForInstanceSegmentationTRT
...
def main() -> None:
    ...
    model = YOLOv8ForInstanceSegmentationTRT.from_pretrained(MODEL_PACKAGE, device=torch.device(DEVICE))
