...
|---|---|---|---|---|---|---|---|
| `gpu-pack-current-001` | `2026-08-12T21:35Z`–pending | The current L40S worker has useful capacity above the existing four-job policy cap | `ck8s-stg/video-proc` Deployment UID `f001fcc0-4cc7-44a5-9b5f-c6f1010a1e4d`: set GPU `MAX_CONCURRENT_JOBS` from `4` to `24`; prior generation `8`, revision `7`, pod-template SHA-256 `b3eecf9e29751dcdd1c3717734824abe9e06b198aac273bed6355a6d07f88545` | worker image `video-processor:2e4a97ee5`; harness `5c8ebd4af`; the deployable chart change must be committed separately if retained | restore `MAX_CONCURRENT_JOBS=4`, wait for rollout, require one ready pool pod, and verify the resulting worker reports capacity 4 | ignored suite `gpu-current-worker-001`; durable analyzed summary to be recorded after the run | pending |
